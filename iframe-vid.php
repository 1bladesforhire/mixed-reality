...
<!-- <section class="" id="hero-banner" ms.cmpgrp="content panel" ms.pgarea="body" data-bi-area="body" data-bi-id="r2a3" data-bi-name="hero-banner">
    <div data-vg="windows-MR-mwf-1a-banner-VG" data-grid="container" data-bi-id="m1r2a3" data-bi-name="windows-MR-mwf-1a-banner-VG">
        <div data-grid="col-11" class="m-banner" data-bi-id="c1m1r2a3" data-bi-name="c1m1r2a3">
            <h1 class="c-heading">Introducing Windows Mixed Reality
            </h1>
            <p class="c-subheading">Immerse yourself in a new reality.</p><a class="mscom-link c-call-to-action c-glyph glyph-play trigger-popup vn1 x-hidden-focus" ms.title="play" aria-label="Click to watch the Windows Mixed Reality video" href="#" data-state="clicked" ms.cmpnm="introducing windows mixed reality"
                ms.interactiontype="26" data-bi-name="watch video" data-bi-vidnm="click to watch the windows mixed reality video" data-bi-bhvr="VIDEOSTART" data-bi-type="learn" data-bi-vidpct="0" data-bi-id="n1c1m1r2a3"><span>WATCH VIDEO</span></a></div>
    </div>
    <div class="multivideosplayer vn1">
        <div class="multivideosplayer herovideo" id="videoplayer1"><span aria-hidden="true" style="display:none;" itemprop="name">Windows Mixed Reality Sizzle</span><span aria-hidden="true" style="display:none;" itemprop="description">Discover a large, evolving catalog of Windows Mixed Reality experiences and apps.</span>
            <div class="mscom-popup" bi:type="Popup" data-closeonoutsideclick="True" xmlns:bi="urn:schemas-microsoft-com:mscom:bi">
                <a class="mscom-link mscom-popup-link " title="Watch video" bi:track="false" ms.title="undefined" ms.cmpnm="introducing windows mixed reality" ms.ea_name="learn"></a>
                <div class="mscom-popup-container mscom-popup-fullwidth mscom-show-popup playing">
                    <div class="mscom-popup-body">
                        <div class="mscom-popup-mask mscom-popup-maskcontent" style="opacity:0.85;filter:alpha(opacity=85);"></div>
                        <div class="mscom-popup-layout x-hidden-focus">
                            <div class="mscom-popup-content">
                                <div class="mscom-popup-content-header"><a class="mscom-link mscom-popup-close" href="/en-us/windows/windows-mixed-reality" bi:track="false" aria-label="Close button, click to close the video window" ms.title="close" ms.cmpnm="introducing windows mixed reality"
                                        ms.ea_name="learn" data-bi-name="close" data-bi-id="n2r2a3"><span class="mscom-popup-close-image"></span><span class="screen-reader-text">Close</span></a></div>
                                <div class="popupVideoPlayer">
                                    <div class="CMSvNextComp mscom-video" id="video-container" bi:type="Video"><iframe src="https://www.youtube.com/embed/h5g0IxhxBoY?rel=0&amp;autoplay=1&amp;enablejsapi=1" class="mscom-youtube-video" frameborder="0" type="text/html" allowfullscreen="true" tabindex="0" title="Windows Mixed Reality Sizzle"
                                            id="widget2"></iframe><a href="javascript:void(0);" class="dummy-anchor">&nbsp;</a><a href="javascript:void(0);" class="dummy-anchor">&nbsp;</a>
                                        <div id="video_error" class="video-error" style="display:none;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="multivideosplayer vn1">
    <div class="multivideosplayer herovideo" id="videoplayer1"><span aria-hidden="true" style="display:none;" itemprop="name">Windows Mixed Reality Sizzle</span><span aria-hidden="true" style="display:none;" itemprop="description">Discover a large, evolving catalog of Windows Mixed Reality experiences and apps.</span>
        <div
            class="mscom-popup" bi:type="Popup" data-closeonoutsideclick="True" xmlns:bi="urn:schemas-microsoft-com:mscom:bi">
            <a class="mscom-link mscom-popup-link " title="Watch video" bi:track="false" ms.title="undefined" ms.cmpnm="introducing windows mixed reality" ms.ea_name="learn"></a>
            <div class="mscom-popup-container mscom-popup-fullwidth">
                <div class="mscom-popup-body">
                    <div class="mscom-popup-mask mscom-popup-maskcontent" style="opacity:0.85;filter:alpha(opacity=85);"></div>
                    <div class="mscom-popup-layout x-hidden-focus">
                        <div class="mscom-popup-content">
                            <div class="mscom-popup-content-header x-hidden-focus"><a class="mscom-link mscom-popup-close" href="/en-us/windows/windows-mixed-reality" bi:track="false" aria-label="Close button, click to close the video window" ms.title="close" ms.cmpnm="introducing windows mixed reality" ms.ea_name="learn"
                                    data-bi-name="close" data-bi-id="n2r2a3"><span class="mscom-popup-close-image"></span><span class="screen-reader-text">Close</span></a></div>
                            <div class="popupVideoPlayer">
                                <div class="CMSvNextComp mscom-video" id="video-container" bi:type="Video"><iframe src="https://www.youtube.com/embed/h5g0IxhxBoY?rel=0" class="mscom-youtube-video" frameborder="0" type="text/html" allowfullscreen="true" tabindex="0" title="Windows Mixed Reality Sizzle" id="widget2"></iframe>
                                    <a
                                        href="javascript:void(0);" class="dummy-anchor">&nbsp;</a><a href="javascript:void(0);" class="dummy-anchor">&nbsp;</a><a href="javascript:void(0);" class="dummy-anchor">&nbsp;</a><a href="javascript:void(0);" class="dummy-anchor">&nbsp;</a>
                                        <div id="video_error"
                                            class="video-error" style="display:none;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="f-core-player">
    <video class="f-video-player x-hidden-focus" preload="metadata" title="xbox" poster="//img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RWfc6u?ver=2984" src="//wus-streaming-video-rt-microsoft-com.akamaized.net/4563f7d4-c8f8-47af-80e8-90235e5f69b1/357ea1a7-052c-43dd-b2d7-eed261e1_1024x576_2729.mp4"></video>
    <div class="f-video-trigger" aria-hidden="true">
        <section class="f-mask-40 theme-light">
            <div>
    ...
    <div class="f-video-cc-overlay" aria-hidden="true" style="bottom: 0px; transition: bottom 0.5s ease-in;"></div>
    <div class="f-video-controls x-hidden-focus" dir="ltr" aria-hidden="false" style="bottom: 0px; transition: bottom 0.5s ease-in;">
        <button type="button" class="f-play-pause c-glyph glyph-play" aria-label="Play">
            <span aria-hidden="true">Play</span>
        </button>
        <button type="button" class="f-live f-live-current c-glyph glyph-view" aria-label="Skip ahead to live broadcast." aria-hidden="true">
            <span aria-hidden="true">Skip ahead to live broadcast.</span>
            LIVE
        </button>
        <span class="f-time" aria-hidden="false">
            <span class="f-current-time">01:07</span> /
        <span class="f-duration">00:00</span>
        </span>
        <div class="c-slider f-progress">
            <input type="range" class="f-seek-bar x-screen-reader" aria-label="Seek" value="67.127352" min="0" step="5">
            <div><button role="slider" aria-valuemin="0" aria-valuemax="100" aria-valuenow="67.127352" aria-label="Seek" style="left: 353.037px;" aria-valuetext="00:01:07"><span>00:01:07</span></button><span style="width: 353.037px;"></span></div>
        </div>
        <button type="button" class="f-options c-glyph glyph-more" aria-label="More options" aria-expanded="false" aria-haspopup="true" data-menu-id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-options-menu">
            <span aria-hidden="true">More options</span>
        </button>
        <div class="f-menu-container">
            <div id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-quality" class="f-player-menu" aria-hidden="true" data-category="quality">
                <ul role="menu" class="c-list f-bare">
                    <li>
                        <button class="c-action-trigger c-glyph glyph-chevron-left active" data-next-menu="back" aria-label="Quality menu - go back to previous menu">Quality</button>
                    </li>
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-HQ">
                        <button class="c-action-trigger active c-glyph glyph-check-mark" data-info="//wus-streaming-video-rt-microsoft-com.akamaized.net/4563f7d4-c8f8-47af-80e8-90235e5f69b1/357ea1a7-052c-43dd-b2d7-eed261e1_1024x576_2729.mp4" role="menuitemradio" aria-setsize="3"
                            aria-posinset="1" aria-selected="true" aria-checked="true" data-video-selectable="true" data-persist="true">HQ</button>
                    </li>
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-SD">
                        <button class="c-action-trigger active c-glyph" data-info="//wus-streaming-video-rt-microsoft-com.akamaized.net/e474fc2b-c3c2-4a04-a571-09200d528961/357ea1a7-052c-43dd-b2d7-eed261e1_640x360_1428.mp4" role="menuitemradio" aria-setsize="3" aria-posinset="2"
                            data-video-selectable="true" data-persist="true">SD</button>
                    </li>
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-LO">
                        <button class="c-action-trigger active c-glyph" data-info="//wus-streaming-video-rt-microsoft-com.akamaized.net/907c0d32-b58b-4503-853d-2d7cb3675540/357ea1a7-052c-43dd-b2d7-eed261e1_320x180_527.mp4" role="menuitemradio" aria-setsize="3" aria-posinset="3"
                            data-video-selectable="true" data-persist="true">LO</button>
                    </li>
                </ul>
            </div>
            <div id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-share" class="f-player-menu" aria-hidden="true" data-category="share">
                <ul role="menu" class="c-list f-bare">
                    <li>
                        <button class="c-action-trigger c-glyph glyph-chevron-left active" data-next-menu="back" aria-label="Share menu - go back to previous menu">Share</button>
                    </li>
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-facebook">
                        <button class="c-action-trigger active" data-info="//www.facebook.com/share.php?u=https%3A%2F%2Ftest.microsoft.com%2Fen-us%2Fonerf%2Fvideoinmodules" role="menuitem">
                    ...
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-twitter">
                        <button class="c-action-trigger active" data-info="//twitter.com/share?url=https%3A%2F%2Ftest.microsoft.com%2Fen-us%2Fonerf%2Fvideoinmodules&amp;text=" role="menuitem">
                    ...
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-linkedin">
                        <button class="c-action-trigger active" data-info="//www.linkedin.com/shareArticle?mini=true&amp;url=https%3A%2F%2Ftest.microsoft.com%2Fen-us%2Fonerf%2Fvideoinmodules&amp;title=&amp;summary=&amp;source=" role="menuitem">
                    ...
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-skype">
                        <button class="c-action-trigger active" data-info="//web.skype.com/share?url=https%3A%2F%2Ftest.microsoft.com%2Fen-us%2Fonerf%2Fvideoinmodules&amp;lang=en-us" role="menuitem">
                        <img src="data:image/svg+xml;base64," alt="" class="c-image">
                        Skype
                    </button>
                    </li>
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-mail">
                        <button class="c-action-trigger active c-glyph glyph-mail" data-info="mailto:?subject=Check out this great video&amp;body=https%3A%2F%2Ftest.microsoft.com%2Fen-us%2Fonerf%2Fvideoinmodules" role="menuitem">
                            Mail
                        </button>
                    </li>
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-copy">
                        <button class="c-action-trigger active c-glyph glyph-copy" data-info="https%3A%2F%2Ftest.microsoft.com%2Fen-us%2Fonerf%2Fvideoinmodules" role="menuitem">
                            Copy link
                        </button>
                    </li>
                </ul>
            </div>
            <div id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-options-menu" class="f-player-menu" aria-hidden="true" data-category="options">
                <ul role="menu" class="c-list f-bare">
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-quality_item">
                        <button class="c-action-trigger active c-glyph glyph-chevron-right" role="menuitem" data-next-menu="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-quality" aria-expanded="false" aria-haspopup="true">
                            Quality
                        </button>
                    </li>
                    <li id="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-share_item">
                        <button class="c-action-trigger active c-glyph glyph-chevron-right" role="menuitem" data-next-menu="coreui-feature-dsbgwj0-videoplayer324ff33e-8327-4841-8d46-fd8dd6342841-share" aria-expanded="false" aria-haspopup="true">
                            Share
                        </button>
                    </li>
                </ul>
        ...
        <button type="button" class="f-volume-button c-glyph glyph-volume" aria-label="Mute"></button>
        <div class="f-volume-slider" aria-hidden="true">
            <div class="c-slider f-vertical">
                <input type="range" class="f-volume-bar f-vertical x-screen-reader" aria-label="Volume" min="0" max="100" step="5" value="80">
                <div><button role="slider" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80" aria-label="Volume" style="left: 67.2px;"><span>80</span></button><span style="width: 67.2px;"></span></div>
            </div>
        </div>
        <button type="button" class="f-full-screen c-glyph glyph-full-screen" aria-label="Full Screen">
            <span aria-hidden="true">Full Screen</span>
        </button>
    </div>
    <div aria-hidden="true" class="c-progress f-indeterminate-local f-progress-large" role="progressbar" tabindex="0" aria-label="Loading" aria-valuetext="Loading...">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
    ...
    <style>
        ...
        *:after {
        ...
        body.d_ie:not(.d_mobile),
        body.d_edge:not(.d_mobile) {
            min-width: 500px
        }
        ...
        .theme-light button.c-action-toggle:active,
        .theme-dark .theme-light button.c-action-toggle:active,
        .theme-dark button.c-action-toggle:active,
        .theme-light .theme-dark button.c-action-toggle:active {
            outline: 1px solid transparent
        }
        ...
        .theme-light .c-blockquote,
        .theme-dark .theme-light .c-blockquote {
            background: #fff;
            color: #000;
            border-color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .c-blockquote.f-lightweight,
        .theme-dark .theme-light .c-blockquote.f-lightweight {
            background: none
        }
        
        .theme-dark .c-blockquote,
        .theme-light .theme-dark .c-blockquote {
            background: #000;
            color: #fff;
            border-color: rgba(255, 255, 255, .8)
        }
        
        .theme-dark .c-blockquote.f-lightweight,
        .theme-light .theme-dark .c-blockquote.f-lightweight {
            background: none
        }
        ...
        .theme-light ul.c-breadcrumb li:after,
        .theme-light ul.c-breadcrumb li:last-child,
        .theme-light ul.c-breadcrumb li:last-child a,
        .theme-dark .theme-light ul.c-breadcrumb li:after,
        .theme-dark .theme-light ul.c-breadcrumb li:last-child,
        .theme-dark .theme-light ul.c-breadcrumb li:last-child a,
        .theme-light ol.c-breadcrumb li:after,
        .theme-light ol.c-breadcrumb li:last-child,
        .theme-light ol.c-breadcrumb li:last-child a,
        .theme-dark .theme-light ol.c-breadcrumb li:after,
        .theme-dark .theme-light ol.c-breadcrumb li:last-child,
        .theme-dark .theme-light ol.c-breadcrumb li:last-child a {
            color: rgba(0, 0, 0, .6)
        }
        
        .theme-light ul.c-breadcrumb li a,
        .theme-dark .theme-light ul.c-breadcrumb li a,
        .theme-light ol.c-breadcrumb li a,
        .theme-dark .theme-light ol.c-breadcrumb li a {
            color: #000;
            text-decoration: none
        }
        
        .theme-light ul.c-breadcrumb li a:hover,
        .theme-dark .theme-light ul.c-breadcrumb li a:hover,
        .theme-light ol.c-breadcrumb li a:hover,
        .theme-dark .theme-light ol.c-breadcrumb li a:hover {
            text-decoration: underline
        }
        
        .theme-dark ul.c-breadcrumb li:after,
        .theme-dark ul.c-breadcrumb li:last-child,
        .theme-dark ul.c-breadcrumb li:last-child a,
        .theme-light .theme-dark ul.c-breadcrumb li:after,
        .theme-light .theme-dark ul.c-breadcrumb li:last-child,
        .theme-light .theme-dark ul.c-breadcrumb li:last-child a,
        .theme-dark ol.c-breadcrumb li:after,
        .theme-dark ol.c-breadcrumb li:last-child,
        .theme-dark ol.c-breadcrumb li:last-child a,
        .theme-light .theme-dark ol.c-breadcrumb li:after,
        .theme-light .theme-dark ol.c-breadcrumb li:last-child,
        .theme-light .theme-dark ol.c-breadcrumb li:last-child a {
            color: rgba(255, 255, 255, .6)
        }
        
        .theme-dark ul.c-breadcrumb li a,
        .theme-light .theme-dark ul.c-breadcrumb li a,
        .theme-dark ol.c-breadcrumb li a,
        .theme-light .theme-dark ol.c-breadcrumb li a {
            color: #fff;
            text-decoration: none
        }
        
        .theme-dark ul.c-breadcrumb li a:hover,
        .theme-light .theme-dark ul.c-breadcrumb li a:hover,
        .theme-dark ol.c-breadcrumb li a:hover,
        .theme-light .theme-dark ol.c-breadcrumb li a:hover {
            text-decoration: underline
        }
        ...
        button.c-button:focus:not(.x-hidden-focus),
        a.c-button[role="button"]:focus:not(.x-hidden-focus) {
            outline: 2px solid #000;
            text-decoration: underline
        }
        ...
        .theme-dark .theme-light button.c-button,
        ...
        .theme-light button.c-button:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button:focus:not(.x-hidden-focus),
        .theme-light a.c-button[role="button"]:focus:not(.x-hidden-focus),
        .theme-dark .theme-light a.c-button[role="button"]:focus:not(.x-hidden-focus) {
        ...
        .theme-dark .theme-light button.c-button:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button:hover,
        .theme-light a.c-button[role="button"]:focus:not(.x-hidden-focus),
        ...
        .theme-light button.c-button:active,
        .theme-dark .theme-light button.c-button:active,
        .theme-light a.c-button[role="button"]:active,
        .theme-dark .theme-light a.c-button[role="button"]:active {
            background: #b3b3b3
        }
        
        .theme-light button.c-button[disabled],
        .theme-dark .theme-light button.c-button[disabled],
        ...
        .theme-light .theme-dark button.c-button,
        ...
        .theme-light .theme-dark button.c-button:focus,
        .theme-dark a.c-button[role="button"]:focus,
        .theme-light .theme-dark a.c-button[role="button"]:focus {
            outline: 1px solid #fff
        }
        
        .theme-dark button.c-button:focus:not(.x-hidden-focus),
        .theme-dark button.c-button:hover,
        .theme-light .theme-dark button.c-button:focus:not(.x-hidden-focus),
        .theme-light .theme-dark button.c-button:hover,
        .theme-dark a.c-button[role="button"]:focus:not(.x-hidden-focus),
        .theme-dark a.c-button[role="button"]:hover,
        .theme-light .theme-dark a.c-button[role="button"]:focus:not(.x-hidden-focus),
        .theme-light .theme-dark a.c-button[role="button"]:hover {
            background: #1a1a1a
        }
        
        .theme-dark button.c-button:active,
        .theme-light .theme-dark button.c-button:active,
        .theme-dark a.c-button[role="button"]:active,
        .theme-light .theme-dark a.c-button[role="button"]:active {
            background: #000
        }
        
        .theme-dark button.c-button[disabled],
        .theme-light .theme-dark button.c-button[disabled],
        ...
        button.c-button.f-lightweight.x-hidden-focus:not(:hover),
        a.c-button[role="button"].f-lightweight.x-hidden-focus:not(:hover) {
            background: none !important;
            text-decoration: none !important;
            outline-color: transparent !important
        }
        
        .theme-light button.c-button.f-lightweight:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button.f-lightweight:focus:not(.x-hidden-focus),
        .theme-light a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus),
        .theme-dark .theme-light a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus) {
            background: rgba(0, 0, 0, .1) content-box
        }
        ...
        .theme-dark .theme-light button.c-button.f-lightweight:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button.f-lightweight:hover,
        .theme-light a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus),
        .theme-light a.c-button[role="button"].f-lightweight:hover,
        .theme-dark .theme-light a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus),
        .theme-dark .theme-light a.c-button[role="button"].f-lightweight:hover {
            color: rgba(0, 0, 0, .9)
        }
        
        .theme-light button.c-button.f-lightweight:active,
        .theme-dark .theme-light button.c-button.f-lightweight:active,
        ...
        .theme-light button.c-button.f-lightweight.x-hidden-focus:not(:hover),
        .theme-dark .theme-light button.c-button.f-lightweight.x-hidden-focus:not(:hover),
        .theme-light a.c-button[role="button"].f-lightweight.x-hidden-focus:not(:hover),
        .theme-dark .theme-light a.c-button[role="button"].f-lightweight.x-hidden-focus:not(:hover) {
            background: none !important;
            text-decoration: none !important;
            outline-color: transparent !important
        }
        
        .theme-dark button.c-button.f-lightweight:focus:not(.x-hidden-focus),
        .theme-light .theme-dark button.c-button.f-lightweight:focus:not(.x-hidden-focus),
        .theme-dark a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus),
        .theme-light .theme-dark a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus) {
            background: rgba(255, 255, 255, .1) content-box
        }
        ...
        .theme-light .theme-dark button.c-button.f-lightweight:focus:not(.x-hidden-focus),
        .theme-light .theme-dark button.c-button.f-lightweight:hover,
        .theme-dark a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus),
        .theme-dark a.c-button[role="button"].f-lightweight:hover,
        .theme-light .theme-dark a.c-button[role="button"].f-lightweight:focus:not(.x-hidden-focus),
        .theme-light .theme-dark a.c-button[role="button"].f-lightweight:hover {
            color: #e6e6e6
        }
        
        .theme-dark button.c-button.f-lightweight:active,
        .theme-light .theme-dark button.c-button.f-lightweight:active,
        .theme-dark a.c-button[role="button"].f-lightweight:active,
        .theme-light .theme-dark a.c-button[role="button"].f-lightweight:active {
            color: #ccc
        }
        
        .theme-dark button.c-button.f-lightweight.x-hidden-focus:not(:hover),
        .theme-light .theme-dark button.c-button.f-lightweight.x-hidden-focus:not(:hover),
        .theme-dark a.c-button[role="button"].f-lightweight.x-hidden-focus:not(:hover),
        .theme-light .theme-dark a.c-button[role="button"].f-lightweight.x-hidden-focus:not(:hover) {
            background: none !important;
            text-decoration: none !important;
            outline-color: transparent !important
        }
        ...
        .theme-dark .theme-light button.c-button.f-lightweight,
        ...
        .theme-light button.c-button.f-lightweight[disabled],
        .theme-dark .theme-light button.c-button.f-lightweight[disabled],
        ...
        .theme-light .theme-dark button.c-button.f-lightweight,
        ...
        .theme-dark button.c-button.f-lightweight[disabled],
        .theme-light .theme-dark button.c-button.f-lightweight[disabled],
        ...
        button.c-button.f-flex,
        a.c-button[role="button"].f-flex {
            width: 100%;
            max-width: 100%;
            white-space: normal
        }
        ...
        a.c-button.f-primary:focus:not(.x-hidden-focus),
        ...
        button.c-button.f-primary:active,
        a.c-button.f-primary:active,
        ...
        button.c-button.f-primary[disabled],
        a.c-button.f-primary[disabled],
        ...
        .theme-light button.c-button[type="submit"],
        .theme-dark .theme-light button.c-button[type="submit"] {
            color: #fff;
            background-color: #000;
            border-color: transparent
        }
        
        .theme-light button.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-light a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-dark .theme-light a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-light button.c-button[type="submit"]:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button[type="submit"]:focus:not(.x-hidden-focus) {
            outline-color: #fff
        }
        ...
        .theme-dark .theme-light button.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button.f-primary:hover,
        .theme-light a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-light a.c-button.f-primary:hover,
        .theme-dark .theme-light a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-dark .theme-light a.c-button.f-primary:hover,
        .theme-light button.c-button[type="submit"]:focus:not(.x-hidden-focus),
        .theme-light button.c-button[type="submit"]:hover,
        .theme-dark .theme-light button.c-button[type="submit"]:focus:not(.x-hidden-focus),
        .theme-dark .theme-light button.c-button[type="submit"]:hover {
            background: #1a1a1a
        }
        
        .theme-light button.c-button.f-primary:active,
        .theme-dark .theme-light button.c-button.f-primary:active,
        .theme-light a.c-button.f-primary:active,
        .theme-dark .theme-light a.c-button.f-primary:active,
        .theme-light button.c-button[type="submit"]:active,
        .theme-dark .theme-light button.c-button[type="submit"]:active {
            background: #333
        }
        
        .theme-light button.c-button.f-primary[disabled],
        .theme-dark .theme-light button.c-button.f-primary[disabled],
        .theme-light a.c-button.f-primary[disabled],
        .theme-dark .theme-light a.c-button.f-primary[disabled],
        .theme-light button.c-button[type="submit"][disabled],
        .theme-dark .theme-light button.c-button[type="submit"][disabled] {
            background-color: rgba(0, 0, 0, .2);
            color: rgba(0, 0, 0, .2)
        }
        ...
        .theme-dark button.c-button[type="submit"],
        .theme-light .theme-dark button.c-button[type="submit"] {
            color: #000;
            background-color: #fff;
            border-color: transparent
        }
        
        .theme-dark button.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-light .theme-dark button.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-dark a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-light .theme-dark a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-dark button.c-button[type="submit"]:focus:not(.x-hidden-focus),
        .theme-light .theme-dark button.c-button[type="submit"]:focus:not(.x-hidden-focus) {
            outline-color: #000
        }
        ...
        .theme-light .theme-dark button.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-light .theme-dark button.c-button.f-primary:hover,
        .theme-dark a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-dark a.c-button.f-primary:hover,
        .theme-light .theme-dark a.c-button.f-primary:focus:not(.x-hidden-focus),
        .theme-light .theme-dark a.c-button.f-primary:hover,
        .theme-dark button.c-button[type="submit"]:focus:not(.x-hidden-focus),
        .theme-dark button.c-button[type="submit"]:hover,
        .theme-light .theme-dark button.c-button[type="submit"]:focus:not(.x-hidden-focus),
        .theme-light .theme-dark button.c-button[type="submit"]:hover {
            background: #e6e6e6
        }
        
        .theme-dark button.c-button.f-primary:active,
        .theme-light .theme-dark button.c-button.f-primary:active,
        .theme-dark a.c-button.f-primary:active,
        .theme-light .theme-dark a.c-button.f-primary:active,
        .theme-dark button.c-button[type="submit"]:active,
        .theme-light .theme-dark button.c-button[type="submit"]:active {
            background: #ccc
        }
        
        .theme-dark button.c-button.f-primary[disabled],
        .theme-light .theme-dark button.c-button.f-primary[disabled],
        .theme-dark a.c-button.f-primary[disabled],
        .theme-light .theme-dark a.c-button.f-primary[disabled],
        .theme-dark button.c-button[type="submit"][disabled],
        .theme-light .theme-dark button.c-button[type="submit"][disabled] {
            background-color: rgba(255, 255, 255, .2);
            color: rgba(255, 255, 255, .2)
        }
        ...
        .theme-light .c-content-toggle button:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-content-toggle button:focus:not(.x-hidden-focus) {
            background: rgba(0, 0, 0, .1) content-box
        }
        
        .theme-light .c-content-toggle button:focus:not(.x-hidden-focus),
        .theme-light .c-content-toggle button:hover,
        .theme-dark .theme-light .c-content-toggle button:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-content-toggle button:hover {
            color: rgba(0, 0, 0, .9)
        }
        
        .theme-light .c-content-toggle button:active,
        .theme-dark .theme-light .c-content-toggle button:active {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .c-content-toggle button.x-hidden-focus:not(:hover),
        .theme-dark .theme-light .c-content-toggle button.x-hidden-focus:not(:hover) {
            background: none !important;
            text-decoration: none !important;
            outline-color: transparent !important
        }
        
        .theme-dark .c-content-toggle button:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-content-toggle button:focus:not(.x-hidden-focus) {
            background: rgba(255, 255, 255, .1) content-box
        }
        
        .theme-dark .c-content-toggle button:focus:not(.x-hidden-focus),
        .theme-dark .c-content-toggle button:hover,
        .theme-light .theme-dark .c-content-toggle button:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-content-toggle button:hover {
            color: #e6e6e6
        }
        
        .theme-dark .c-content-toggle button:active,
        .theme-light .theme-dark .c-content-toggle button:active {
            color: #ccc
        }
        
        .theme-dark .c-content-toggle button.x-hidden-focus:not(:hover),
        .theme-light .theme-dark .c-content-toggle button.x-hidden-focus:not(:hover) {
            background: none !important;
            text-decoration: none !important;
            outline-color: transparent !important
        }
        ...
        .c-date-time-picker [data-date-time-picker="date-selector"]>div li[aria-selected="true"],
        .c-date-time-picker [data-date-time-picker="time-selector12"]>div li[aria-selected="true"],
        .c-date-time-picker [data-date-time-picker="time-selector24"]>div li[aria-selected="true"] {
            color: #fff
        }
        
        .c-date-time-picker [data-date-time-picker="date-selector"]>div li[aria-selected="true"]:focus,
        .c-date-time-picker [data-date-time-picker="time-selector12"]>div li[aria-selected="true"]:focus,
        .c-date-time-picker [data-date-time-picker="time-selector24"]>div li[aria-selected="true"]:focus {
            background: #005da6
        }
        
        .c-date-time-picker [data-date-time-picker="date-selector"]>div li[aria-selected="true"]:hover,
        .c-date-time-picker [data-date-time-picker="date-selector"]>div li[aria-selected="true"].x-hidden-focus,
        .c-date-time-picker [data-date-time-picker="time-selector12"]>div li[aria-selected="true"]:hover,
        .c-date-time-picker [data-date-time-picker="time-selector12"]>div li[aria-selected="true"].x-hidden-focus,
        .c-date-time-picker [data-date-time-picker="time-selector24"]>div li[aria-selected="true"]:hover,
        .c-date-time-picker [data-date-time-picker="time-selector24"]>div li[aria-selected="true"].x-hidden-focus {
            background: transparent
        }
        ...
        .c-date-time-picker [data-date-time-picker="date-selector"]>div li:focus,
        .c-date-time-picker [data-date-time-picker="time-selector12"]>div li:focus,
        .c-date-time-picker [data-date-time-picker="time-selector24"]>div li:focus {
            outline: 1px dashed #000
        }
        ...
        .c-dialog.f-lightbox [role="dialog"]>button.c-glyph {
            padding: 0;
            background: none;
            border: 0
        }
        ...
        .c-dialog.f-flow [role="dialog"]>.c-glyph:focus,
        ...
        .c-dialog.f-flow [role="dialog"]>.c-glyph:before,
        .c-dialog.f-lightbox [role="dialog"]>.c-glyph:before {
            margin: 10px;
            vertical-align: middle
        }
        
        .c-dialog.f-flow [role="dialog"] .f-dialog-scroll,
        .c-dialog.f-lightbox [role="dialog"] .f-dialog-scroll {
            overflow-y: auto;
            max-height: 600px;
            min-width: 245px
        }
        
        .c-dialog.f-flow [role="dialog"] .c-group .c-button,
        .c-dialog.f-lightbox [role="dialog"] .c-group .c-button {
            margin-top: 36px
        }
        ...
        .theme-light .c-dialog [role="dialog"],
        .theme-dark .theme-light .c-dialog [role="dialog"] {
            background: #fff;
            border-color: #000
        }
        
        .theme-light .c-dialog [role="dialog"] .c-glyph,
        .theme-dark .theme-light .c-dialog [role="dialog"] .c-glyph {
            color: #000
        }
        
        .theme-light .c-dialog [role="dialog"] .c-glyph:hover,
        .theme-dark .theme-light .c-dialog [role="dialog"] .c-glyph:hover {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .c-dialog [role="dialog"] .c-glyph:focus,
        .theme-dark .theme-light .c-dialog [role="dialog"] .c-glyph:focus {
            outline-color: rgba(0, 0, 0, .6)
        }
        
        .theme-light .c-dialog>[role="presentation"],
        .theme-dark .theme-light .c-dialog>[role="presentation"] {
            background: rgba(255, 255, 255, .9)
        }
        
        .theme-dark .c-dialog [role="dialog"],
        .theme-light .theme-dark .c-dialog [role="dialog"] {
            background: #000;
            border-color: #fff
        }
        
        .theme-dark .c-dialog [role="dialog"] .c-glyph,
        .theme-light .theme-dark .c-dialog [role="dialog"] .c-glyph {
            color: #fff
        }
        
        .theme-dark .c-dialog [role="dialog"] .c-glyph:hover,
        .theme-light .theme-dark .c-dialog [role="dialog"] .c-glyph:hover {
            color: rgba(255, 255, 255, .8)
        }
        
        .theme-dark .c-dialog [role="dialog"] .c-glyph:focus,
        .theme-light .theme-dark .c-dialog [role="dialog"] .c-glyph:focus {
            outline-color: rgba(255, 255, 255, .6)
        }
        ...
        .c-drawer.f-divider>button,
        .c-drawer.f-divider .f-toggle,
        .c-drawer.f-divider>header>button,
        .c-drawer.f-divider>header .f-toggle {
        ...
        .c-drawer[data-js-collapse].f-show>button:after,
        .c-drawer[data-js-collapse].f-show .f-toggle:after,
        .c-drawer[data-js-collapse].f-show>header>button:after,
        .c-drawer[data-js-collapse].f-show>header .f-toggle:after {
            display: none
        }
        
        .c-drawer[data-js-collapse].f-show>button:hover,
        .c-drawer[data-js-collapse].f-show .f-toggle:hover,
        .c-drawer[data-js-collapse].f-show>header>button:hover,
        .c-drawer[data-js-collapse].f-show>header .f-toggle:hover {
            background: transparent
        }
        
        .c-drawer[data-js-collapse].f-divider>button,
        .c-drawer[data-js-collapse].f-divider .f-toggle,
        .c-drawer[data-js-collapse].f-divider>header>button,
        .c-drawer[data-js-collapse].f-divider>header .f-toggle {
            border-bottom: 1px solid rgba(0, 0, 0, .2)
        }
        ...
        .c-file input.c-text-field[type="text"][readonly]:active,
        .c-file input.c-text-field[type="text"][readonly]:focus {
            border-color: #0067b8
        }
        ...
        .theme-light a.c-hyperlink:not(.f-image).x-hidden-focus:not(:hover),
        .theme-dark .theme-light a.c-hyperlink:not(.f-image).x-hidden-focus:not(:hover) {
            background: none !important;
            text-decoration: none !important;
            outline-color: transparent !important
        }
        ...
        .theme-dark a.c-hyperlink:not(.f-image).x-hidden-focus:not(:hover),
        .theme-light .theme-dark a.c-hyperlink:not(.f-image).x-hidden-focus:not(:hover) {
            background: none !important;
            text-decoration: none !important;
            outline-color: transparent !important
        }
        ...
        nav.c-in-page-navigation a:active,
        nav.c-in-page-navigation a.f-active {
            color: #000
        }
        ...
        nav.c-in-page-navigation.f-dropdown .f-dropdown-menu.f-border [aria-expanded]:active,
        nav.c-in-page-navigation.f-dropdown .f-dropdown-menu.f-border [aria-expanded]:focus {
            border-color: #0067b8
        }
        ...
        nav.c-link-navigation li a.c-hyperlink.f-image:focus p,
        nav.c-link-navigation li a.c-hyperlink.f-image:hover p {
            color: #005da6;
            text-decoration: underline
        }
        ...
        .c-navigation-menu ul .f-sub-menu button+ul,
        .c-navigation-menu ul .f-sub-menu button+ol,
        .c-navigation-menu ol .f-sub-menu button+ul,
        .c-navigation-menu ol .f-sub-menu button+ol {
            position: absolute;
            left: 100%;
            top: -1px;
            z-index: 500;
        ...
        .c-navigation-menu ul .f-sub-menu button+ul a,
        .c-navigation-menu ul .f-sub-menu button+ul button,
        .c-navigation-menu ul .f-sub-menu button+ol a,
        .c-navigation-menu ul .f-sub-menu button+ol button,
        .c-navigation-menu ol .f-sub-menu button+ul a,
        .c-navigation-menu ol .f-sub-menu button+ul button,
        .c-navigation-menu ol .f-sub-menu button+ol a,
        .c-navigation-menu ol .f-sub-menu button+ol button {
            background: rgba(0, 0, 0, .1)
        }
        
        .c-navigation-menu ul .f-sub-menu button+ul a:hover,
        .c-navigation-menu ul .f-sub-menu button+ul a:focus,
        .c-navigation-menu ul .f-sub-menu button+ul button:hover,
        .c-navigation-menu ul .f-sub-menu button+ul button:focus,
        .c-navigation-menu ul .f-sub-menu button+ol a:hover,
        .c-navigation-menu ul .f-sub-menu button+ol a:focus,
        .c-navigation-menu ul .f-sub-menu button+ol button:hover,
        .c-navigation-menu ul .f-sub-menu button+ol button:focus,
        .c-navigation-menu ol .f-sub-menu button+ul a:hover,
        .c-navigation-menu ol .f-sub-menu button+ul a:focus,
        .c-navigation-menu ol .f-sub-menu button+ul button:hover,
        .c-navigation-menu ol .f-sub-menu button+ul button:focus,
        .c-navigation-menu ol .f-sub-menu button+ol a:hover,
        .c-navigation-menu ol .f-sub-menu button+ol a:focus,
        .c-navigation-menu ol .f-sub-menu button+ol button:hover,
        .c-navigation-menu ol .f-sub-menu button+ol button:focus {
            background: rgba(0, 0, 0, .15)
        }
        
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ul a,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ul button,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ol a,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ol button,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ul a,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ul button,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ol a,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ol button,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ul a,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ul button,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ol a,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ol button,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ul a,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ul button,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ol a,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ol button {
            background: rgba(0, 0, 0, .15)
        }
        
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ul a:hover,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ul a:focus,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ul button:hover,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ul button:focus,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ol a:hover,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ol a:focus,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ol button:hover,
        .c-navigation-menu ul .f-sub-menu button+ul .f-sub-menu button+ol button:focus,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ul a:hover,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ul a:focus,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ul button:hover,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ul button:focus,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ol a:hover,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ol a:focus,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ol button:hover,
        .c-navigation-menu ul .f-sub-menu button+ol .f-sub-menu button+ol button:focus,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ul a:hover,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ul a:focus,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ul button:hover,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ul button:focus,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ol a:hover,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ol a:focus,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ol button:hover,
        .c-navigation-menu ol .f-sub-menu button+ul .f-sub-menu button+ol button:focus,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ul a:hover,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ul a:focus,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ul button:hover,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ul button:focus,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ol a:hover,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ol a:focus,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ol button:hover,
        .c-navigation-menu ol .f-sub-menu button+ol .f-sub-menu button+ol button:focus {
            background: rgba(0, 0, 0, .2)
        }
        ...
        .c-pivot .no-js:not(.f-disabled)>header>a.f-active,
        .c-pivot .no-js:not(.f-disabled)>div>a.f-active {
            font-weight: 600
        }
        ...
        .c-pivot:not(.f-disabled)>header>a.f-active:focus:not(.x-hidden-focus),
        .c-pivot:not(.f-disabled)>div>a.f-active:focus:not(.x-hidden-focus) {
            outline: transparent;
            background: rgba(0, 103, 184, .1) content-box
        }
        ...
        .c-pivot>.c-flipper[aria-hidden="false"]+header>a:first-child,
        .c-pivot>.c-flipper[aria-hidden="false"]+div>a:first-child {
            margin-left: 28px
        }
        ...
        .c-pivot>div>a:first-child {
            margin-left: 0
        }
        
        .c-pivot>header>a.c-glyph:before,
        .c-pivot>div>a.c-glyph:before {
            width: 16px;
            height: 16px;
            margin-right: 10px;
            vertical-align: middle;
        ...
        .c-pivot.f-active-bold:not(.f-disabled)>header>a.f-active,
        .c-pivot.f-active-bold:not(.f-disabled)>div>a.f-active {
            font-weight: 700
        }
        
        .theme-light .c-pivot.f-disabled>header>a,
        .theme-light .c-pivot.f-disabled>div>a,
        .theme-dark .theme-light .c-pivot.f-disabled>header>a,
        .theme-dark .theme-light .c-pivot.f-disabled>div>a {
            color: rgba(0, 0, 0, .4)
        }
        
        .theme-light .c-pivot:not(.f-disabled)>header>a,
        .theme-light .c-pivot:not(.f-disabled)>div>a,
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>header>a,
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>div>a {
            color: rgba(0, 0, 0, .6)
        }
        
        .theme-light .c-pivot:not(.f-disabled)>header>a.f-active,
        .theme-light .c-pivot:not(.f-disabled)>div>a.f-active,
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>header>a.f-active,
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>div>a.f-active {
            color: #000;
            border-color: #000
        }
        
        .theme-light .c-pivot:not(.f-disabled)>header>a.f-active:focus:not(.x-hidden-focus),
        .theme-light .c-pivot:not(.f-disabled)>div>a.f-active:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>header>a.f-active:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>div>a.f-active:focus:not(.x-hidden-focus) {
            outline: transparent;
            background: rgba(0, 0, 0, .1) content-box
        }
        
        .theme-light .c-pivot:not(.f-disabled)>header>a:hover,
        .theme-light .c-pivot:not(.f-disabled)>div>a:hover,
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>header>a:hover,
        .theme-dark .theme-light .c-pivot:not(.f-disabled)>div>a:hover {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-dark .c-pivot:not(.f-disabled)>header>a,
        .theme-dark .c-pivot:not(.f-disabled)>div>a,
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>header>a,
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>div>a {
            color: rgba(255, 255, 255, .6)
        }
        
        .theme-dark .c-pivot:not(.f-disabled)>header>a.f-active,
        .theme-dark .c-pivot:not(.f-disabled)>div>a.f-active,
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>header>a.f-active,
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>div>a.f-active {
            color: #fff;
            border-color: #fff
        }
        
        .theme-dark .c-pivot:not(.f-disabled)>header>a.f-active:focus:not(.x-hidden-focus),
        .theme-dark .c-pivot:not(.f-disabled)>div>a.f-active:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>header>a.f-active:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>div>a.f-active:focus:not(.x-hidden-focus) {
            outline: transparent;
            background: rgba(255, 255, 255, .1) content-box
        }
        
        .theme-dark .c-pivot:not(.f-disabled)>header>a:hover,
        .theme-dark .c-pivot:not(.f-disabled)>div>a:hover,
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>header>a:hover,
        .theme-light .theme-dark .c-pivot:not(.f-disabled)>div>a:hover {
            color: rgba(255, 255, 255, .8)
        }
        
        .theme-dark .c-pivot.f-disabled>header>a,
        .theme-dark .c-pivot.f-disabled>div>a,
        .theme-light .theme-dark .c-pivot.f-disabled>header>a,
        .theme-light .theme-dark .c-pivot.f-disabled>div>a {
            color: rgba(255, 255, 255, .4)
        }
        ...
        .c-range-slider .c-text-field[type="number"]::-webkit-outer-spin-button,
        .c-range-slider .c-text-field[type="number"]::-webkit-inner-spin-button {
            -webkit-appearance: none;
            margin: 0
        }
        ...
        .c-range-slider [role="slider"] {
            ...
            width: 12px;
            height: 16px;
            background-image: url("data:image/svg+xml,20xmlns22http223D200201620width221220height22163E20points2272062002002062072012207223D3A22/3C/svg%3E")
        }
        ...
        a.c-refine-item:hover {
            background: rgba(0, 0, 0, .1)
        }
        
        button.c-refine-item:active,
        a.c-refine-item:active {
            background: rgba(0, 0, 0, .3)
        }
        ...
        button[aria-selected="true"].c-refine-item:hover,
        a[aria-selected="true"].c-refine-item:hover,
        button[aria-checked="true"].c-refine-item:hover,
        a[aria-checked="true"].c-refine-item:hover,
        button.f-selected.c-refine-item:hover,
        a.f-selected.c-refine-item:hover {
            background: rgba(0, 0, 0, .1)
        }
        
        button[aria-selected="true"].c-refine-item:active,
        a[aria-selected="true"].c-refine-item:active,
        button[aria-checked="true"].c-refine-item:active,
        a[aria-checked="true"].c-refine-item:active,
        button.f-selected.c-refine-item:active,
        a.f-selected.c-refine-item:active {
            background: rgba(0, 0, 0, .2)
        }
        
        button[aria-selected="true"].c-refine-item:after,
        a[aria-selected="true"].c-refine-item:after,
        button[aria-checked="true"].c-refine-item:after,
        a[aria-checked="true"].c-refine-item:after,
        button.f-selected.c-refine-item:after,
        a.f-selected.c-refine-item:after {
            display: inline-block
        }
        ...
        button.c-select-button.f-selected {
            border-width: 2px;
            border-color: #000;
            padding: 5px 9px
        }
        ...
        button.c-select-button:hover.f-selected {
            border-color: #0067b8
        }
        ...
        button.c-select-button[data-select-button-swatch].f-selected {
            box-shadow: inset 0 0 0 1px #fff
        }
        ...
        button.c-select-button[data-select-button-swatch].f-selected:hover,
        button.c-select-button[data-select-button-swatch].f-selected:focus {
            border-color: #999;
            box-shadow: inset 0 0 0 1px #fff
        }
        ...
        .theme-light button.c-select-button,
        .theme-dark .theme-light button.c-select-button {
            background: rgba(255, 255, 255, 0);
            border-color: rgba(0, 0, 0, .4);
            color: #000
        }
        
        .theme-light button.c-select-button:focus,
        .theme-dark .theme-light button.c-select-button:focus {
            outline-color: #000
        }
        
        .theme-light button.c-select-button:hover,
        .theme-dark .theme-light button.c-select-button:hover {
            border-color: #000
        }
        
        .theme-light button.c-select-button:active,
        .theme-dark .theme-light button.c-select-button:active {
            background: rgba(0, 0, 0, .4);
            outline: none
        }
        
        .theme-light button.c-select-button[disabled],
        .theme-dark .theme-light button.c-select-button[disabled] {
            border-color: rgba(0, 0, 0, .2);
            color: rgba(0, 0, 0, .2)
        }
        
        .theme-light button.c-select-button[aria-pressed="true"],
        .theme-light button.c-select-button.f-selected,
        .theme-dark .theme-light button.c-select-button[aria-pressed="true"],
        .theme-dark .theme-light button.c-select-button.f-selected {
            border-color: #000
        }
        
        .theme-light button.c-select-button[aria-pressed="true"]:hover,
        .theme-light button.c-select-button.f-selected:hover,
        .theme-dark .theme-light button.c-select-button[aria-pressed="true"]:hover,
        .theme-dark .theme-light button.c-select-button.f-selected:hover {
            border-color: #0067b8
        }
        
        .theme-dark button.c-select-button,
        .theme-light .theme-dark button.c-select-button {
            background: rgba(255, 255, 255, 0);
            border-color: rgba(255, 255, 255, .4);
            color: #fff
        }
        
        .theme-dark button.c-select-button:focus,
        .theme-light .theme-dark button.c-select-button:focus {
            outline-color: #fff;
            border-color: rgba(255, 255, 255, .4)
        }
        
        .theme-dark button.c-select-button:hover,
        .theme-light .theme-dark button.c-select-button:hover {
            border-color: #fff
        }
        
        .theme-dark button.c-select-button:active,
        .theme-light .theme-dark button.c-select-button:active {
            background: rgba(255, 255, 255, .4);
            outline: none
        }
        
        .theme-dark button.c-select-button[disabled],
        .theme-light .theme-dark button.c-select-button[disabled] {
            border-color: rgba(255, 255, 255, .2);
            color: rgba(255, 255, 255, .2)
        }
        
        .theme-dark button.c-select-button[aria-pressed="true"],
        .theme-dark button.c-select-button[aria-pressed="true"]:focus,
        .theme-dark button.c-select-button.f-selected,
        .theme-dark button.c-select-button.f-selected:focus,
        .theme-light .theme-dark button.c-select-button[aria-pressed="true"],
        .theme-light .theme-dark button.c-select-button[aria-pressed="true"]:focus,
        .theme-light .theme-dark button.c-select-button.f-selected,
        .theme-light .theme-dark button.c-select-button.f-selected:focus {
            border-color: #fff
        }
        
        .theme-dark button.c-select-button[aria-pressed="true"]:hover,
        .theme-dark button.c-select-button.f-selected:hover,
        .theme-light .theme-dark button.c-select-button[aria-pressed="true"]:hover,
        .theme-light .theme-dark button.c-select-button.f-selected:hover {
            border-color: #0067b8
        }
        ...
        button.c-select-button.f-cue-check[aria-pressed="true"]:before,
        button.c-select-button.f-cue-check.f-selected:before {
            width: 30px;
            height: 30px;
            padding-top: 4px;
            position: absolute;
        ...
        button.c-select-button.f-cue-check:active[aria-pressed="true"]:before,
        button.c-select-button.f-cue-check:active.f-selected:before,
        button.c-select-button.f-cue-check:hover[aria-pressed="true"]:before,
        button.c-select-button.f-cue-check:hover.f-selected:before {
            background-color: #0067b8
        }
        ...
        .c-select-menu.f-accent>a,
        .c-select-menu.f-accent>button {
            color: #0067b8
        }
        
        .c-select-menu.f-accent>a:after,
        .c-select-menu.f-accent>button:after {
            color: rgba(0, 0, 0, .6)
        }
        
        .c-select-menu.f-accent>a:hover,
        .c-select-menu.f-accent>a:active,
        .c-select-menu.f-accent>button:hover,
        .c-select-menu.f-accent>button:active {
            color: #0067b8
        }
        
        .c-select-menu.f-accent>a:hover:after,
        .c-select-menu.f-accent>a:active:after,
        .c-select-menu.f-accent>button:hover:after,
        .c-select-menu.f-accent>button:active:after {
            color: #000
        }
        ...
        .c-select-menu.f-border [aria-expanded]:focus:not(.x-hidden-focus) {
            border-color: #0067b8
        }
        ...
        .c-select-menu[aria-disabled="true"]>a,
        .c-select-menu[aria-disabled="true"]>a:hover,
        .c-select-menu[aria-disabled="true"]>a:focus,
        .c-select-menu[aria-disabled="true"]>a:active,
        .c-select-menu[aria-disabled="true"]>a:after,
        .c-select-menu[aria-disabled="true"]>button,
        .c-select-menu[aria-disabled="true"]>button:hover,
        .c-select-menu[aria-disabled="true"]>button:focus,
        .c-select-menu[aria-disabled="true"]>button:active,
        ...
        .theme-light .c-select-menu>button,
        .theme-light .c-select-menu>button:after,
        .theme-dark .theme-light .c-select-menu>a,
        .theme-dark .theme-light .c-select-menu>a:after,
        ...
        .theme-light .c-select-menu>button:hover,
        .theme-light .c-select-menu>button:hover:after,
        .theme-dark .theme-light .c-select-menu>a:hover,
        .theme-dark .theme-light .c-select-menu>a:hover:after,
        ...
        .theme-light .c-select-menu>button:focus,
        .theme-dark .theme-light .c-select-menu>a:focus,
        .theme-dark .theme-light .c-select-menu>button:focus {
            outline-color: #000
        }
        
        .theme-light .c-select-menu.f-border>a,
        .theme-light .c-select-menu.f-border>button,
        .theme-dark .theme-light .c-select-menu.f-border>a,
        ...
        .theme-light .c-select-menu.f-border>button:after,
        .theme-dark .theme-light .c-select-menu.f-border>a:after,
        .theme-dark .theme-light .c-select-menu.f-border>button:after {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .c-select-menu.f-border>a:hover,
        .theme-light .c-select-menu.f-border>button:hover,
        .theme-dark .theme-light .c-select-menu.f-border>a:hover,
        ...
        .theme-light .c-select-menu.f-border>button:hover:after,
        .theme-dark .theme-light .c-select-menu.f-border>a:hover:after,
        .theme-dark .theme-light .c-select-menu.f-border>button:hover:after {
            color: #000
        }
        
        .theme-light .c-select-menu.f-border>a:focus,
        .theme-light .c-select-menu.f-border>button:focus,
        .theme-dark .theme-light .c-select-menu.f-border>a:focus,
        ...
        .theme-dark .c-select-menu>button,
        .theme-dark .c-select-menu>button:after,
        .theme-light .theme-dark .c-select-menu>a,
        .theme-light .theme-dark .c-select-menu>a:after,
        ...
        .theme-dark .c-select-menu>button:hover,
        .theme-dark .c-select-menu>button:hover:after,
        .theme-light .theme-dark .c-select-menu>a:hover,
        .theme-light .theme-dark .c-select-menu>a:hover:after,
        ...
        .theme-dark .c-select-menu>button:focus,
        .theme-light .theme-dark .c-select-menu>a:focus,
        .theme-light .theme-dark .c-select-menu>button:focus {
            outline-color: #fff
        }
        
        .theme-dark .c-select-menu.f-border>a,
        .theme-dark .c-select-menu.f-border>button,
        .theme-light .theme-dark .c-select-menu.f-border>a,
        ...
        .theme-dark .c-select-menu.f-border>button:after,
        .theme-light .theme-dark .c-select-menu.f-border>a:after,
        .theme-light .theme-dark .c-select-menu.f-border>button:after {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-dark .c-select-menu.f-border>a:hover,
        .theme-dark .c-select-menu.f-border>button:hover,
        .theme-light .theme-dark .c-select-menu.f-border>a:hover,
        ...
        .theme-dark .c-select-menu.f-border>button:hover:after,
        .theme-light .theme-dark .c-select-menu.f-border>a:hover:after,
        .theme-light .theme-dark .c-select-menu.f-border>button:hover:after {
            color: #000
        }
        
        .theme-dark .c-select-menu.f-border>a:focus,
        .theme-dark .c-select-menu.f-border>button:focus,
        .theme-light .theme-dark .c-select-menu.f-border>a:focus,
        ...
        .d_xbox .c-select-menu>a:after,
        .d_xbox .c-select-menu>button:after {
            color: #000;
            font-size: 15px;
            padding-top: 4px;
            padding-right: 3px
        ...
        .d_xbox .c-select-menu>a:active,
        .d_xbox .c-select-menu>a:focus,
        .d_xbox .c-select-menu>button:active,
        .d_xbox .c-select-menu>button:focus {
            background: #0067b8;
            outline: 2px solid #000;
            text-decoration: none
        }
        ...
        .d_xbox .c-select-menu [aria-expanded]:active,
        .d_xbox .c-select-menu [aria-expanded]:focus {
            background: #0067b8;
            color: #000;
            outline: 2px solid #000;
            text-decoration: none
        ...
        .d_xbox .c-select-menu .c-menu.f-scroll>.c-menu-item>a:active,
        .d_xbox .c-select-menu .c-menu.f-scroll>.c-menu-item>a:focus {
            outline-offset: -2px
        }
        
        .d_xbox .c-select-menu .c-menu-item a,
        .d_xbox .c-select-menu .c-menu-item span,
        .d_xbox .c-select-menu .c-menu-item button {
            color: #000;
            background: #fff;
            min-height: 44px
        }
        
        .d_xbox .c-select-menu .c-menu-item a:focus,
        .d_xbox .c-select-menu .c-menu-item span:focus,
        .d_xbox .c-select-menu .c-menu-item button:focus {
            outline: 2px solid #000;
            background: #fff
        }
        
        .d_xbox .c-select-menu .c-menu-item a[aria-selected="true"],
        .d_xbox .c-select-menu .c-menu-item span[aria-selected="true"],
        .d_xbox .c-select-menu .c-menu-item button[aria-selected="true"] {
            background: #0067b8;
            color: #000
        }
        ...
        .theme-light .c-select select,
        .theme-dark .theme-light .c-select select {
            background: #fff;
            color: #000
        }
        
        .theme-light .c-select:after,
        .theme-dark .theme-light .c-select:after {
            color: #000
        }
        
        .theme-dark .c-select select,
        .theme-light .theme-dark .c-select select {
            background: rgba(255, 255, 255, .8);
            color: #000
        }
        
        .theme-dark .c-select:after,
        .theme-light .theme-dark .c-select:after {
            color: #000
        }
        ...
        .c-structured-list .f-column .f-row:before,
        ...
        .c-table .c-call-to-action:hover span {
            text-decoration: underline
        }
        ...
        .theme-light .c-table .c-call-to-action,
        .theme-dark .theme-light .c-table .c-call-to-action {
            color: #000;
            background: transparent;
            border-color: transparent
        }
        
        .theme-light .c-table .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-table .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(0, 0, 0, .1) content-box
        }
        
        .theme-light .c-table .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .c-table .c-call-to-action:hover,
        .theme-dark .theme-light .c-table .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-table .c-call-to-action:hover {
            color: rgba(0, 0, 0, .9)
        }
        ...
        .theme-light .c-table .c-call-to-action:active,
        .theme-dark .theme-light .c-table .c-call-to-action:active {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .c-table .c-call-to-action[aria-disabled="true"],
        .theme-dark .theme-light .c-table .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #999
        }
        
        .theme-dark .c-table .c-call-to-action,
        .theme-light .theme-dark .c-table .c-call-to-action {
            color: #fff;
            background: transparent;
            border-color: transparent
        }
        
        .theme-dark .c-table .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-table .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(255, 255, 255, .1) content-box
        }
        
        .theme-dark .c-table .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .c-table .c-call-to-action:hover,
        .theme-light .theme-dark .c-table .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-table .c-call-to-action:hover {
            color: #e6e6e6
        }
        ...
        .theme-dark .c-table .c-call-to-action:active,
        .theme-light .theme-dark .c-table .c-call-to-action:active {
            color: #ccc
        }
        
        .theme-dark .c-table .c-call-to-action[aria-disabled="true"],
        .theme-light .theme-dark .c-table .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #666
        }
        ...
        .c-text-action input[type="text"][disabled]+button:hover,
        .c-text-action input[type="text"][disabled]+button:active,
        .c-text-action input[type="text"][disabled]+button:focus {
            background: #fff;
            color: rgba(0, 0, 0, .2)
        }
        ...
        .c-text-action input[type="text"][readonly]+button:hover,
        .c-text-action input[type="text"][readonly]+button:active,
        .c-text-action input[type="text"][readonly]+button:focus {
            color: rgba(0, 0, 0, .6)
        }
        ...
        @media screen and (-ms-high-contrast) {
            ...
            .c-text-action button:active,
            .c-text-action button:focus {
                background: #fff
            }
        }
        ...
        .theme-light .c-textarea textarea,
        .theme-dark .theme-light .c-textarea textarea {
            background: rgba(255, 255, 255, .6);
            border: 1px solid #000;
            color: #000
        }
        
        .theme-dark .c-textarea textarea,
        .theme-light .theme-dark .c-textarea textarea {
            background: rgba(255, 255, 255, .6);
            border-color: #fff;
            color: #000
        }
        
        .c-textarea+p[class*="c-caption"],
        .c-textarea+p[class*="c-paragraph"] {
            padding-top: 16px
        }
        ...
        .c-track-list-placement>a:before,
        ...
        .c-track-list-placement>a:hover>picture img,
        .c-track-list-placement>a:focus>picture img {
        ...
        .m-highlight-feature>div .c-call-to-action:hover span {
            text-decoration: underline
        }
        ...
        .theme-dark .theme-light .m-highlight-feature>div .c-call-to-action {
            color: #000;
            background: transparent;
            border-color: transparent
        }
        
        .theme-light .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(0, 0, 0, .1) content-box
        }
        
        .theme-light .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .m-highlight-feature>div .c-call-to-action:hover,
        .theme-dark .theme-light .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .m-highlight-feature>div .c-call-to-action:hover {
            color: rgba(0, 0, 0, .9)
        }
        ...
        .theme-light .m-highlight-feature>div .c-call-to-action:active,
        .theme-dark .theme-light .m-highlight-feature>div .c-call-to-action:active {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .m-highlight-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-dark .theme-light .m-highlight-feature>div .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #999
        }
        
        .theme-dark .m-highlight-feature>div .c-call-to-action,
        .theme-light .theme-dark .m-highlight-feature>div .c-call-to-action {
            color: #fff;
            background: transparent;
            border-color: transparent
        }
        
        .theme-dark .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(255, 255, 255, .1) content-box
        }
        
        .theme-dark .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .m-highlight-feature>div .c-call-to-action:hover,
        .theme-light .theme-dark .m-highlight-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .m-highlight-feature>div .c-call-to-action:hover {
            color: #e6e6e6
        }
        ...
        .theme-dark .m-highlight-feature>div .c-call-to-action:active,
        .theme-light .theme-dark .m-highlight-feature>div .c-call-to-action:active {
            color: #ccc
        }
        
        .theme-dark .m-highlight-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-light .theme-dark .m-highlight-feature>div .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #666
        }
        ...
        .pad-highlight-feature+.pad-highlight-feature .m-highlight-feature.f-lean,
        .m-highlight-feature+.m-highlight-feature.f-lean {
            margin-top: 48px
        }
        ...
        .m-feature.f-background-neutral-00 {
            background: #fff
        }
        
        .c-feature.f-background-neutral-10,
        .m-feature.f-background-neutral-10 {
            background: #e6e6e6
        }
        
        .c-feature.f-background-neutral-20,
        .m-feature.f-background-neutral-20 {
            background: #d2d2d2
        }
        
        .c-feature.f-background-neutral-30,
        .m-feature.f-background-neutral-30 {
            background: #acacac
        }
        ...
        .m-feature.f-background-neutral-55 {
            background: #737373
        }
        
        .c-feature.f-background-neutral-65,
        .m-feature.f-background-neutral-65 {
            background: #505050
        }
        
        .c-feature.f-background-neutral-75,
        .m-feature.f-background-neutral-75 {
            background: #464646
        }
        
        .c-feature.f-background-neutral-80,
        .m-feature.f-background-neutral-80 {
            background: #2f2f2f
        }
        
        .c-feature.f-background-neutral-90,
        .m-feature.f-background-neutral-90 {
            background: #171717
        }
        
        .c-feature.f-background-neutral-100,
        .m-feature.f-background-neutral-100 {
            background: #000
        }
        
        .c-feature[class*="f-background-neutral-"],
        .c-feature[class*="f-background-neutral-"] .c-call-to-action,
        .c-feature.f-background-accent,
        .c-feature.f-background-accent .c-call-to-action,
        .m-feature[class*="f-background-neutral-"],
        .m-feature[class*="f-background-neutral-"] .c-call-to-action,
        .m-feature.f-background-accent,
        .m-feature.f-background-accent .c-call-to-action {
            color: #fff
        }
        
        .c-feature[class*="f-background-neutral-"] .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-accent .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature[class*="f-background-neutral-"] .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-accent .c-call-to-action:focus:not(.x-hidden-focus) {
            outline: transparent;
            background: rgba(255, 255, 255, .1) content-box
        }
        
        .c-feature[class*="f-background-neutral-"] .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature[class*="f-background-neutral-"] .c-call-to-action:hover,
        .c-feature.f-background-accent .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-accent .c-call-to-action:hover,
        .m-feature[class*="f-background-neutral-"] .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature[class*="f-background-neutral-"] .c-call-to-action:hover,
        .m-feature.f-background-accent .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-accent .c-call-to-action:hover {
            color: #e6e6e6
        }
        
        .c-feature[class*="f-background-neutral-"] .c-call-to-action:active,
        .c-feature.f-background-accent .c-call-to-action:active,
        .m-feature[class*="f-background-neutral-"] .c-call-to-action:active,
        .m-feature.f-background-accent .c-call-to-action:active {
            background: none;
            color: #ccc
        }
        
        .c-feature.f-background-neutral-00,
        .c-feature.f-background-neutral-00 .c-call-to-action,
        .c-feature.f-background-neutral-10,
        .c-feature.f-background-neutral-10 .c-call-to-action,
        .c-feature.f-background-neutral-20,
        .c-feature.f-background-neutral-20 .c-call-to-action,
        .c-feature.f-background-neutral-30,
        .c-feature.f-background-neutral-30 .c-call-to-action,
        .m-feature.f-background-neutral-00,
        .m-feature.f-background-neutral-00 .c-call-to-action,
        .m-feature.f-background-neutral-10,
        .m-feature.f-background-neutral-10 .c-call-to-action,
        .m-feature.f-background-neutral-20,
        .m-feature.f-background-neutral-20 .c-call-to-action,
        .m-feature.f-background-neutral-30,
        .m-feature.f-background-neutral-30 .c-call-to-action {
            color: #000
        }
        
        .c-feature.f-background-neutral-00 .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-neutral-10 .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-neutral-20 .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-neutral-30 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-00 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-10 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-20 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-30 .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(0, 0, 0, .1) content-box
        }
        
        .c-feature.f-background-neutral-00 .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-neutral-00 .c-call-to-action:hover,
        .c-feature.f-background-neutral-10 .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-neutral-10 .c-call-to-action:hover,
        .c-feature.f-background-neutral-20 .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-neutral-20 .c-call-to-action:hover,
        .c-feature.f-background-neutral-30 .c-call-to-action:focus:not(.x-hidden-focus),
        .c-feature.f-background-neutral-30 .c-call-to-action:hover,
        .m-feature.f-background-neutral-00 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-00 .c-call-to-action:hover,
        .m-feature.f-background-neutral-10 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-10 .c-call-to-action:hover,
        .m-feature.f-background-neutral-20 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-20 .c-call-to-action:hover,
        .m-feature.f-background-neutral-30 .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature.f-background-neutral-30 .c-call-to-action:hover {
            color: #000
        }
        
        .c-feature.f-background-neutral-00 .c-call-to-action:active,
        .c-feature.f-background-neutral-10 .c-call-to-action:active,
        .c-feature.f-background-neutral-20 .c-call-to-action:active,
        .c-feature.f-background-neutral-30 .c-call-to-action:active,
        .m-feature.f-background-neutral-00 .c-call-to-action:active,
        .m-feature.f-background-neutral-10 .c-call-to-action:active,
        .m-feature.f-background-neutral-20 .c-call-to-action:active,
        .m-feature.f-background-neutral-30 .c-call-to-action:active {
            color: #000
        }
        
        .c-feature .c-call-to-action:focus:not(.x-hidden-focus) span,
        .c-feature .c-call-to-action:hover span,
        .m-feature .c-call-to-action:focus:not(.x-hidden-focus) span,
        .m-feature .c-call-to-action:hover span {
            text-decoration: underline
        }
        ...
        .m-feature>div .c-badge,
        .m-feature>div .c-logo {
            margin-top: 12px
        }
        
        .c-feature>div .c-badge+.c-heading,
        .c-feature>div .c-logo+.c-heading,
        .m-feature>div .c-badge+.c-heading,
        .m-feature>div .c-logo+.c-heading {
            padding-top: 8px
        }
        ...
        .m-feature>div .c-logo img {
            margin: 0 auto
        }
        
        .c-feature>div .c-call-to-action,
        .m-feature>div .c-call-to-action {
            background: transparent;
            color: #0067b8;
            border-color: transparent;
            border-width: 2px;
        ...
        .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .m-feature>div .c-call-to-action:hover,
        .m-feature>div .c-call-to-action:active {
            background: transparent;
            outline: transparent;
            border-color: transparent
        }
        ...
        .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus) span,
        .c-feature>div .c-call-to-action:hover span,
        .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus) span,
        .m-feature>div .c-call-to-action:hover span {
            text-decoration: underline
        }
        ...
        .c-feature>div .c-call-to-action[aria-disabled="true"],
        .m-feature>div .c-call-to-action[aria-disabled="true"] {
            cursor: not-allowed;
            color: #cce1f1
        }
        
        .theme-light .c-feature>div .c-call-to-action,
        .theme-dark .theme-light .c-feature>div .c-call-to-action,
        .theme-light .m-feature>div .c-call-to-action,
        .theme-dark .theme-light .m-feature>div .c-call-to-action {
            color: #000;
            background: transparent;
            border-color: transparent
        }
        
        .theme-light .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(0, 0, 0, .1) content-box
        }
        
        .theme-light .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .c-feature>div .c-call-to-action:hover,
        .theme-dark .theme-light .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .c-feature>div .c-call-to-action:hover,
        .theme-light .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .m-feature>div .c-call-to-action:hover,
        .theme-dark .theme-light .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .m-feature>div .c-call-to-action:hover {
            color: rgba(0, 0, 0, .9)
        }
        ...
        .theme-light .c-feature>div .c-call-to-action:active,
        .theme-dark .theme-light .c-feature>div .c-call-to-action:active,
        .theme-light .m-feature>div .c-call-to-action:active,
        .theme-dark .theme-light .m-feature>div .c-call-to-action:active {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .c-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-dark .theme-light .c-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-light .m-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-dark .theme-light .m-feature>div .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #999
        }
        
        .theme-dark .c-feature>div .c-call-to-action,
        .theme-light .theme-dark .c-feature>div .c-call-to-action,
        .theme-dark .m-feature>div .c-call-to-action,
        .theme-light .theme-dark .m-feature>div .c-call-to-action {
            color: #fff;
            background: transparent;
            border-color: transparent
        }
        
        .theme-dark .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(255, 255, 255, .1) content-box
        }
        
        .theme-dark .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .c-feature>div .c-call-to-action:hover,
        .theme-light .theme-dark .c-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .c-feature>div .c-call-to-action:hover,
        .theme-dark .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .m-feature>div .c-call-to-action:hover,
        .theme-light .theme-dark .m-feature>div .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .m-feature>div .c-call-to-action:hover {
            color: #e6e6e6
        }
        ...
        .theme-dark .c-feature>div .c-call-to-action:active,
        .theme-light .theme-dark .c-feature>div .c-call-to-action:active,
        .theme-dark .m-feature>div .c-call-to-action:active,
        .theme-light .theme-dark .m-feature>div .c-call-to-action:active {
            color: #ccc
        }
        
        .theme-dark .c-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-light .theme-dark .c-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-dark .m-feature>div .c-call-to-action[aria-disabled="true"],
        .theme-light .theme-dark .m-feature>div .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #666
        }
        
        .c-feature>div .c-group,
        .m-feature>div .c-group {
            display: block;
            overflow: visible;
            margin-top: 10px
        }
        ...
        .m-feature>div .c-group .c-call-to-action {
            padding-right: 16px;
            margin-top: 0;
            margin-right: 4px
        }
        ...
        .c-feature picture,
        .c-feature .c-image-action,
        .c-feature .c-video,
        .c-feature .c-video-player,
        .c-feature .m-ambient-video,
        .m-feature picture,
        .m-feature .c-image-action,
        .m-feature .c-video,
        .m-feature .c-video-player,
        .m-feature .m-ambient-video {
            display: block;
            width: 100%;
            max-width: 100%
        }
        ...
        .c-feature .c-image-action a,
        .c-feature .c-image-action button,
        .m-feature .c-image-action a,
        .m-feature .c-image-action button {
            width: 48px;
            height: 48px;
            margin: 0;
            margin-top: 0;
        ...
        .c-feature .c-image-action a:before,
        .c-feature .c-image-action button:before,
        .m-feature .c-image-action a:before,
        .m-feature .c-image-action button:before {
            margin: 0;
            position: absolute;
            top: calc(50% - 12px);
            left: calc(50% - 12px);
        ...
        .c-feature .c-image-action a:hover,
        .c-feature .c-image-action button:hover,
        .m-feature .c-image-action a:hover,
        .m-feature .c-image-action button:hover {
            text-decoration: none;
            background: rgba(0, 0, 0, .7)
        }
        
        .c-feature .c-image-action a:active,
        .c-feature .c-image-action button:active,
        .m-feature .c-image-action a:active,
        .m-feature .c-image-action button:active {
            background: rgba(0, 0, 0, .8)
        }
        
        .c-feature .c-image-action picture,
        .m-feature .c-image-action picture {
            width: 100%
        }
        ...
        .c-feature.f-align-left>div.m-ambient-video,
        .c-feature.f-align-left>div.c-video-player,
        .c-feature.f-align-right>div.m-ambient-video,
        .c-feature.f-align-right>div.c-video-player,
        .m-feature.f-align-left>div.m-ambient-video,
        .m-feature.f-align-left>div.c-video-player,
        .m-feature.f-align-right>div.m-ambient-video,
        .m-feature.f-align-right>div.c-video-player {
            padding: 0
        }
        ...
        .m-feature.f-align-center>div .c-group {
            display: block
        }
        
        .c-feature.f-align-center>div .c-group .c-call-to-action,
        .m-feature.f-align-center>div .c-group .c-call-to-action {
            margin: 0 2px
        }
        
        .c-feature.f-align-center>div .c-image,
        .m-feature.f-align-center>div .c-image {
            display: inline-block
        }
        
        .c-feature.f-align-center>div .c-logo,
        .m-feature.f-align-center>div .c-logo {
            margin: 0 auto
        }
        
        .c-feature.f-align-center picture,
        .c-feature.f-align-center .c-image-action,
        .c-feature.f-align-center .c-video,
        .c-feature.f-align-center .c-video-player,
        .c-feature.f-align-center .m-ambient-video,
        .m-feature.f-align-center picture,
        .m-feature.f-align-center .c-image-action,
        .m-feature.f-align-center .c-video,
        .m-feature.f-align-center .c-video-player,
        .m-feature.f-align-center .m-ambient-video {
            width: 100%
        }
        
        @media only screen and (min-width: 540px) {
            .c-feature.f-align-center,
            .m-feature.f-align-center {
                min-height: 300px
            }
            ...
            .c-feature.f-align-left>div.c-video,
            .c-feature.f-align-left>div.m-ambient-video,
            .c-feature.f-align-left>div.c-video-player,
            .c-feature.f-align-right>div.c-video,
            .c-feature.f-align-right>div.m-ambient-video,
            .c-feature.f-align-right>div.c-video-player,
            .m-feature.f-align-left>div.c-video,
            .m-feature.f-align-left>div.m-ambient-video,
            .m-feature.f-align-left>div.c-video-player,
            .m-feature.f-align-right>div.c-video,
            .m-feature.f-align-right>div.m-ambient-video,
            .m-feature.f-align-right>div.c-video-player {
                width: 100%
            }
            .c-feature.f-align-left .c-logo img,
            .c-feature.f-align-right .c-logo img,
            .m-feature.f-align-left .c-logo img,
            .m-feature.f-align-right .c-logo img {
                margin: 0 auto
            }
        }
        ...
        @media only screen and (min-width: 768px) {
            ...
            .m-feature.f-align-left picture,
            .m-feature.f-align-right picture {
                width: 50%
            }
            .c-feature.f-align-left picture img,
            .c-feature.f-align-right picture img,
            .m-feature.f-align-left picture img,
            .m-feature.f-align-right picture img {
                right: 0
            }
            .c-feature.f-align-left>div,
            .c-feature.f-align-right>div,
            ...
            .c-feature.f-align-left>div .c-logo img,
            .c-feature.f-align-right>div .c-logo img,
            .m-feature.f-align-left>div .c-logo img,
            .m-feature.f-align-right>div .c-logo img {
                margin: 0
            }
            .c-feature.f-align-left>div.c-video,
            .c-feature.f-align-left>div.c-video-player,
            ...
            .c-feature.f-align-left>div.c-video>h1,
            .c-feature.f-align-left>div.c-video-player>h1,
            .c-feature.f-align-left>div.m-ambient-video>h1,
            .c-feature.f-align-right>div.c-video>h1,
            .c-feature.f-align-right>div.c-video-player>h1,
            .c-feature.f-align-right>div.m-ambient-video>h1,
            .m-feature.f-align-left>div.c-video>h1,
            .m-feature.f-align-left>div.c-video-player>h1,
            .m-feature.f-align-left>div.m-ambient-video>h1,
            .m-feature.f-align-right>div.c-video>h1,
            .m-feature.f-align-right>div.c-video-player>h1,
            .m-feature.f-align-right>div.m-ambient-video>h1 {
                display: none
            }
            .c-feature.f-align-left>div.c-video video,
            .c-feature.f-align-left>div.c-video-player video,
            .c-feature.f-align-left>div.m-ambient-video video,
            .c-feature.f-align-right>div.c-video video,
            .c-feature.f-align-right>div.c-video-player video,
            .c-feature.f-align-right>div.m-ambient-video video,
            .m-feature.f-align-left>div.c-video video,
            .m-feature.f-align-left>div.c-video-player video,
            .m-feature.f-align-left>div.m-ambient-video video,
            .m-feature.f-align-right>div.c-video video,
            .m-feature.f-align-right>div.c-video-player video,
            .m-feature.f-align-right>div.m-ambient-video video {
                width: 100%;
                min-width: 100%;
                height: 100%;
                max-height: 100%
            ...
            .c-feature.f-align-left>div .c-heading,
            .c-feature.f-align-right>div .c-heading,
            .m-feature.f-align-left>div .c-heading,
            .m-feature.f-align-right>div .c-heading {
                padding-top: 0
            }
            .c-feature.f-align-left .c-image-action,
            .c-feature.f-align-right .c-image-action,
            .m-feature.f-align-left .c-image-action,
            .m-feature.f-align-right .c-image-action {
                width: 50%
            }
            .c-feature.f-align-left .c-image-action picture,
            .c-feature.f-align-right .c-image-action picture,
            .m-feature.f-align-left .c-image-action picture,
            .m-feature.f-align-right .c-image-action picture {
                width: 100%
            }
            .c-feature.f-align-left>div,
            .m-feature.f-align-left>div {
            ...
            .c-feature.f-align-left .c-video-player,
            .c-feature.f-align-left .m-ambient-video,
            .m-feature.f-align-left picture,
            .m-feature.f-align-left .c-image-action,
            .m-feature.f-align-left .c-video,
            .m-feature.f-align-left .c-video-player,
            .m-feature.f-align-left .m-ambient-video {
                float: right
            }
            .c-feature.f-align-right>div,
            .m-feature.f-align-right>div {
            ...
            .c-feature.f-align-right .c-video-player,
            .c-feature.f-align-right .m-ambient-video,
            .m-feature.f-align-right picture,
            .m-feature.f-align-right .c-image-action,
            .m-feature.f-align-right .c-video,
            .m-feature.f-align-right .c-video-player,
            .m-feature.f-align-right .m-ambient-video {
                float: left;
                left: 0
            }
            ...
            .c-feature.f-align-right.f-image-priority>div.c-video-player,
            .c-feature.f-align-right.f-image-priority>div.m-ambient-video,
            .m-feature.f-align-right.f-image-priority>div.c-video,
            .m-feature.f-align-right.f-image-priority>div.c-video-player,
            .m-feature.f-align-right.f-image-priority>div.m-ambient-video {
                left: 0
            }
            .c-feature.f-set-ratio.f-align-left,
            .c-feature.f-set-ratio.f-align-right,
            .m-feature.f-set-ratio.f-align-left,
            .m-feature.f-set-ratio.f-align-right {
                position: relative;
                padding-bottom: 37.5%
            }
        }
        ...
        @media only screen and (min-width: 768px) {
            .c-feature.f-set-ratio.f-align-left picture,
            .c-feature.f-set-ratio.f-align-left .c-image-action,
            .c-feature.f-set-ratio.f-align-left .c-video-player,
            .c-feature.f-set-ratio.f-align-left .c-video,
            .c-feature.f-set-ratio.f-align-left .m-ambient-video,
            .c-feature.f-set-ratio.f-align-right picture,
            .c-feature.f-set-ratio.f-align-right .c-image-action,
            .c-feature.f-set-ratio.f-align-right .c-video-player,
            .c-feature.f-set-ratio.f-align-right .c-video,
            .c-feature.f-set-ratio.f-align-right .m-ambient-video,
            .m-feature.f-set-ratio.f-align-left picture,
            .m-feature.f-set-ratio.f-align-left .c-image-action,
            .m-feature.f-set-ratio.f-align-left .c-video-player,
            .m-feature.f-set-ratio.f-align-left .c-video,
            .m-feature.f-set-ratio.f-align-left .m-ambient-video,
            .m-feature.f-set-ratio.f-align-right picture,
            .m-feature.f-set-ratio.f-align-right .c-image-action,
            .m-feature.f-set-ratio.f-align-right .c-video-player,
            .m-feature.f-set-ratio.f-align-right .c-video,
            .m-feature.f-set-ratio.f-align-right .m-ambient-video {
                position: absolute
            }
            .c-feature.f-set-ratio.f-align-left picture,
            .c-feature.f-set-ratio.f-align-right picture,
            ...
            .c-feature.f-set-ratio.f-align-left picture img,
            .c-feature.f-set-ratio.f-align-right picture img,
            .m-feature.f-set-ratio.f-align-left picture img,
            .m-feature.f-set-ratio.f-align-right picture img {
                right: 0
            }
        ...
        @media only screen and (min-width: 768px) {
            .c-feature.f-set-ratio.f-align-left:not(.f-image-priority) .m-ambient-video,
            .c-feature.f-set-ratio.f-align-right:not(.f-image-priority) .m-ambient-video,
            .m-feature.f-set-ratio.f-align-left:not(.f-image-priority) .m-ambient-video,
            .m-feature.f-set-ratio.f-align-right:not(.f-image-priority) .m-ambient-video {
                height: 100%
            }
            .c-feature.f-set-ratio.f-align-left>div,
            .m-feature.f-set-ratio.f-align-left>div {
                left: 0
            }
            .c-feature.f-set-ratio.f-align-left picture,
            .c-feature.f-set-ratio.f-align-left .c-image-action,
            ...
            .c-feature.f-set-ratio.f-align-right>div,
            .m-feature.f-set-ratio.f-align-right>div {
                left: 50%
            }
            .c-feature.f-set-ratio.f-align-right picture,
            .c-feature.f-set-ratio.f-align-right .c-image-action,
            ...
            .c-feature.f-set-ratio.f-align-right.f-image-priority>div,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>div {
                left: 50%
            }
            .c-feature.f-set-ratio.f-align-right.f-image-priority>div.c-video,
            .c-feature.f-set-ratio.f-align-right.f-image-priority>div.c-video-player,
            .c-feature.f-set-ratio.f-align-right.f-image-priority>div.m-ambient-video,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>div.c-video,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>div.c-video-player,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>div.m-ambient-video {
                left: 0
            }
            .c-feature.f-align-right,
            .m-feature.f-align-right {
        ...
        @media only screen and (min-width: 1084px) {
            ...
            .c-feature.f-align-right.f-image-priority picture,
            .c-feature.f-align-left.f-image-priority picture,
            .m-feature.f-align-right.f-image-priority picture,
            .m-feature.f-align-left.f-image-priority picture {
                width: 65%
            }
            .c-feature.f-align-right.f-image-priority>div,
            ...
            .c-feature.f-align-right.f-image-priority>div.c-video-player,
            .c-feature.f-align-right.f-image-priority>div.m-ambient-video,
            .c-feature.f-align-left.f-image-priority>div.c-video,
            .c-feature.f-align-left.f-image-priority>div.c-video-player,
            .c-feature.f-align-left.f-image-priority>div.m-ambient-video,
            .m-feature.f-align-right.f-image-priority>div.c-video,
            .m-feature.f-align-right.f-image-priority>div.c-video-player,
            .m-feature.f-align-right.f-image-priority>div.m-ambient-video,
            .m-feature.f-align-left.f-image-priority>div.c-video,
            .m-feature.f-align-left.f-image-priority>div.c-video-player,
            .m-feature.f-align-left.f-image-priority>div.m-ambient-video {
                width: 65%;
                max-width: 65%
            }
            .c-feature.f-align-right.f-image-priority>div,
            ...
            .c-feature.f-align-center>div.c-video-player,
            .c-feature.f-align-center>div.m-ambient-video,
            .m-feature.f-align-center>div.c-video,
            .m-feature.f-align-center>div.c-video-player,
            .m-feature.f-align-center>div.m-ambient-video {
                max-width: 100%
            }
            .c-feature.f-set-ratio.f-align-right.f-image-priority>div,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>div {
            ...
            .c-feature.f-set-ratio.f-align-right.f-image-priority picture,
            .c-feature.f-set-ratio.f-align-right.f-image-priority>.c-video,
            .c-feature.f-set-ratio.f-align-right.f-image-priority>.c-video-player,
            .c-feature.f-set-ratio.f-align-right.f-image-priority>.m-ambient-video,
            .m-feature.f-set-ratio.f-align-right.f-image-priority picture,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>.c-video,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>.c-video-player,
            .m-feature.f-set-ratio.f-align-right.f-image-priority>.m-ambient-video {
                right: 35%
            }
            .c-feature.f-set-ratio.f-align-left.f-image-priority>div,
            .m-feature.f-set-ratio.f-align-left.f-image-priority>div {
                right: 65%
            }
            .c-feature.f-set-ratio.f-align-left.f-image-priority picture,
            .c-feature.f-set-ratio.f-align-left.f-image-priority>.c-video,
            .c-feature.f-set-ratio.f-align-left.f-image-priority>.c-video-player,
            .c-feature.f-set-ratio.f-align-left.f-image-priority>.m-ambient-video,
            .m-feature.f-set-ratio.f-align-left.f-image-priority picture,
            .m-feature.f-set-ratio.f-align-left.f-image-priority>.c-video,
            .m-feature.f-set-ratio.f-align-left.f-image-priority>.c-video-player,
            .m-feature.f-set-ratio.f-align-left.f-image-priority>.m-ambient-video {
                left: 35%
            }
        }
        ...
        .c-feature.f-feature-small,
        .m-feature.f-feature-small {
            min-height: 96px
        }
        
        .c-feature.f-feature-small picture>img,
        ...
        @media only screen and (min-width: 768px) {
            ...
            .c-feature.f-feature-small>div,
            .m-feature.f-feature-small>div {
                padding-left: 88px;
                padding-right: 44px
            }
            .c-feature.f-feature-small picture,
        ...
        .m-content-placement-item[data-js-href]:hover>div .c-heading,
        .m-content-placement-item[data-js-href]:hover>div>.c-call-to-action span,
        .m-content-placement-item[data-js-href]:hover>div>.c-hyperlink,
        .m-content-placement-item[data-js-href]:hover>div>.c-group>.c-call-to-action:first-child span,
        .m-content-placement-item[data-js-href]:hover>div>.c-group>.c-hyperlink:first-child,
        .c-content-placement[data-js-href]:hover>div .c-heading,
        .c-content-placement[data-js-href]:hover>div>.c-call-to-action span,
        .c-content-placement[data-js-href]:hover>div>.c-hyperlink,
        .c-content-placement[data-js-href]:hover>div>.c-group>.c-call-to-action:first-child span,
        .c-content-placement[data-js-href]:hover>div>.c-group>.c-hyperlink:first-child {
            text-decoration: underline
        }
        ...
        .m-hero-item.theme-dark .c-call-to-action:focus:not(.x-hidden-focus),
        .c-hero.theme-dark .c-call-to-action:focus:not(.x-hidden-focus) {
        ...
        .m-hero-item.theme-light .c-call-to-action:focus:not(.x-hidden-focus),
        .c-hero.theme-light .c-call-to-action:focus:not(.x-hidden-focus) {
        ...
        .m-banner .c-call-to-action:hover span {
            text-decoration: underline
        }
        ...
        .theme-dark .theme-light .m-banner .c-call-to-action {
            color: #000;
            background: transparent;
            border-color: transparent
        }
        
        .theme-light .m-banner .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .m-banner .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(0, 0, 0, .1) content-box
        }
        
        .theme-light .m-banner .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .m-banner .c-call-to-action:hover,
        .theme-dark .theme-light .m-banner .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .theme-light .m-banner .c-call-to-action:hover {
            color: rgba(0, 0, 0, .9)
        }
        ...
        .theme-light .m-banner .c-call-to-action:active,
        .theme-dark .theme-light .m-banner .c-call-to-action:active {
            color: rgba(0, 0, 0, .8)
        }
        
        .theme-light .m-banner .c-call-to-action[aria-disabled="true"],
        .theme-dark .theme-light .m-banner .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #999
        }
        
        .theme-dark .m-banner .c-call-to-action,
        .theme-light .theme-dark .m-banner .c-call-to-action {
            color: #fff;
            background: transparent;
            border-color: transparent
        }
        
        .theme-dark .m-banner .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .m-banner .c-call-to-action:focus:not(.x-hidden-focus) {
            background: rgba(255, 255, 255, .1) content-box
        }
        
        .theme-dark .m-banner .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-dark .m-banner .c-call-to-action:hover,
        .theme-light .theme-dark .m-banner .c-call-to-action:focus:not(.x-hidden-focus),
        .theme-light .theme-dark .m-banner .c-call-to-action:hover {
            color: #e6e6e6
        }
        ...
        .theme-dark .m-banner .c-call-to-action:active,
        .theme-light .theme-dark .m-banner .c-call-to-action:active {
            color: #ccc
        }
        
        .theme-dark .m-banner .c-call-to-action[aria-disabled="true"],
        .theme-light .theme-dark .m-banner .c-call-to-action[aria-disabled="true"] {
            background: transparent;
            color: #666
        }
        ...
        .c-uhfh>div a.c-action-trigger,
        .c-uhfh>div a.c-action-trigger.glyph-shopping-cart,
        .c-uhfh>div a.c-action-trigger.glyph-shopping-bag,
        .c-uhfh>div button.c-action-trigger,
        .c-uhfh>div button.c-action-trigger.glyph-shopping-cart,
        .c-uhfh>div button.c-action-trigger.glyph-shopping-bag {
            color: rgba(0, 0, 0, .6)
        }
        ...
        .c-uhfh .c-action-trigger.glyph-shopping-cart:before,
        .c-uhfh .c-action-trigger.glyph-shopping-bag:before {
            line-height: 46px;
            margin-top: 1px;
            display: inline-block;
            float: left
        ...
        .c-uhfh .c-action-trigger.glyph-shopping-cart span {
            font-size: 11px;
            line-height: 16px;
        ...
        .c-uhfh .c-action-trigger.glyph-shopping-bag span {
            background: #0078d7;
            border: 1px solid #fff;
            border-radius: 10px;
            color: #fff;
        ...
        @media only screen and (max-width: 767px) {
            ...
            .c-uhfh .c-uhf-menu>button:after,
            .c-uhfh .c-uhf-menu>button:hover:after {
                color: #000
            }
            ...
            .c-uhfh .c-uhf-menu ul[aria-hidden="false"] {
                display: block;
                max-width: none
            }
        ...
        @media only screen and (min-width: 768px) and (min-width:630px) and (max-width:839px) {
        ...
        @media only screen and (min-width: 768px) and (min-width:840px) and (max-width:1049px) {
            .c-uhfh .f-multi-column.f-multi-column-6,
            .c-uhfh .f-multi-column.f-multi-column-5,
            .c-uhfh .f-multi-column.f-multi-column-4 {
                width: 840px
        ...
        @media only screen and (min-width: 768px) and (min-width:1050px) and (max-width:1259px) {
            .c-uhfh .f-multi-column.f-multi-column-6,
            .c-uhfh .f-multi-column.f-multi-column-5 {
                width: 1050px
            }
        ...
        @media only screen and (min-width: 768px) and (min-width:1400px) and (max-width:1778px) {
            .c-uhfh.f-transparent {
                margin-top: 8px
            }
        }
        
        @media only screen and (min-width: 768px) and (min-width:1779px) {
            .c-uhfh.f-transparent {
                margin-top: 12px
            }
        }
        ...
        @media screen and (min-width: 768px) {
            ...
            #epb .epb-container.epb-brand-color>div .c-paragraph .c-group .c-action-cancel:hover,
            #epb .epb-container.epb-brand-color>div .c-paragraph .c-group .c-action-cancel:focus {
            ...
            #epb .epb-container.epb-brand-color>div .c-paragraph .c-group .c-action-open:hover,
            #epb .epb-container.epb-brand-color>div .c-paragraph .c-group .c-action-open:focus {
            ...
            #epb .epb-container.epb-default-color .c-group .c-action-cancel:hover,
            #epb .epb-container.epb-default-color .c-group .c-action-cancel:focus {
                background-color: #e6e6e6
            }
            ...
            #epb .epb-container.epb-default-color .c-group .c-action-open:hover,
            #epb .epb-container.epb-default-color .c-group .c-action-open:focus {
