                ...
                <section class="m-content-placement-item f-size-medium x-type-center">
                    ...
                    <div>
                        ...
                        <ul class="c-list">
                            ...
                            <li>NVIDIA GeForce GTX 1070 graphics</li>
                            <li>Includes wired keyboard and mouse</li>
                        </ul>
        ...
        <div data-grid="col-4">
            <div data-grid="col-12" class="dark">
                <section class="m-content-placement-item f-size-medium">
                    ...
                    <div>
                        <h3 class="c-heading">For the gamer</h3>
                        <p class="c-paragraph">The robust Alienware Aurora R6 desktop PC is geared towards diehard gamers looking to take their gaming to the virtual realm.</p>
                        <ul class="c-list">
                            <li>Intel Core i7-7700</li>
                            <li>16GB memory/256GB SSD + 2TB HDD</li>
                            <li>NVIDIA GeForce GTX 1070 graphics</li>
                            <li>Includes Alienware keyboard and mouse</li>
                        </ul>
                        <div class="c-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                            <meta itemprop="priceCurrency" content="USD">
                            <span>$</span>
        ...
        <div data-grid="col-4 pad-6x">
            <div data-grid="col-12" class="dark">
                <section class="m-content-placement-item f-size-medium short-img">
                    ...
                    <div>
                        <h3 class="c-heading">For the enthusiast</h3>
                        <p class="c-paragraph">The beastly ASUS ROG laptop is loaded for those serious about taking mixed reality on the road and to the next level.</p>
                        <ul class="c-list">
                            <li>17.3-inch Full HD display</li>
                            <li>Intel Core i7-7820HK</li>
                            <li>16GB memory/1TB HDD + 512GB SSD</li>
                            <li>NVIDIA GeForce GTX 1070 graphics </li>
                        </ul>
                        <div class="c-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                            <meta itemprop="priceCurrency" content="USD">
