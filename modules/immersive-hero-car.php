...
<!-- <div class="m-hero">
    <div class="c-carousel f-multi-slide f-auto-play" role="region" aria-label="Label" data-js-interval="6000">
        ...
        <div itemscope itemtype="http://schema.org/ItemList">
            <ul>
                <li id="x-align-left" data-f-theme="light" class="f-active" role="tabpanel">
                ...
                <li id="x-align-center" data-f-theme="light" role="tabpanel">
                    <section class="m-hero-item f-x-center f-y-top context-accessory theme-light" itemscope itemtype="http://schema.org/Product">
                        <picture>
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1779px)">
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1400px)">
                            <source srcset="http://placehold.it/1259x472" media="(min-width: 1084px)">
                ...
                <li id="x-align-right" data-f-theme="light" role="tabpanel">
                    <section class="m-hero-item f-x-right f-y-top context-accessory theme-light" itemscope itemtype="http://schema.org/Product">
                        <picture>
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1779px)">
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1400px)">
                            <source srcset="http://placehold.it/1259x472" media="(min-width: 1084px)">
                ...
                <li id="y-align-top" data-f-theme="light" role="tabpanel">
                    <section class="m-hero-item f-x-left f-y-top context-accessory theme-light" itemscope itemtype="http://schema.org/Product">
                        <picture>
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1779px)">
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1400px)">
                ...
                <li id="y-align-center" data-f-theme="light" role="tabpanel">
                    <section class="m-hero-item f-x-left f-y-center context-accessory theme-light" itemscope itemtype="http://schema.org/Product">
                        <picture>
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1779px)">
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1400px)">
                            <source srcset="http://placehold.it/1259x472" media="(min-width: 1084px)">
                ...
                <li id="y-align-bottom" data-f-theme="light" role="tabpanel">
                    <section class="m-hero-item f-x-left f-y-bottom context-accessory theme-light" itemscope itemtype="http://schema.org/Product">
                        <picture>
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1779px)">
                            <source srcset="http://placehold.it/1600x600" media="(min-width: 1400px)">
                            <source srcset="http://placehold.it/1259x472" media="(min-width: 1084px)">
