<div class="m-immersive-hero" style="background: #F0F0F0;">
    <div class="c-carousel f-multi-slide" role="region" aria-label="Label">
        <div class="c-sequence-indicator" role="tablist">
            <button role="tab" aria-selected="true" aria-label="View dell Visor" aria-controls="default-align-top" title="default-align-top"></button>
                    ...
                    <section class="m-immersive-hero-item f-align-top">
                        ...
                        <div>
                            <div>
                                ...
                                <div class="cta">
                                    <a href="#" role="button" class="m-call-to-action m-background-blue">
                                        <span>Add to bag</span>
                                    </a>
                                    <a href="#" role="button" class="m-call-to-action m-background-neutral-20">
                                        <span>Find in store</span>
                                    </a>
                                    <p class="c-caption-2 x-p-t-2x x-hidden-focus">
