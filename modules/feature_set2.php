    ...
    <section>
        ...
        <div class="c-pivot" data-grid="col-12">
            ...
            <div role="tablist">
                ...
                <a role="tab" aria-controls="newRTBItemImage2 newRTBItemContent2">Your command center</a>
                <a role="tab" aria-controls="newRTBItemImage3 newRTBItemContent3">Connect with confidence</a>
            </div>
                ...
                <ul>
                    <li id="newRTBItemImage1" data-f-theme="light" class="f-active" role="tabpanel">
                        <picture class="c-image">
                            <source srcset="assets/handheldcontrollerPanels.jpg" media="(min-width: 1779px)">
                            <source srcset="assets/handheldcontrollerPanels.jpg" media="(min-width:1400px)">
                            <source srcset="assets/handheldcontrollerPanels.jpg" media="(min-width:1084px)">
                            <source srcset="assets/handheldcontrollerPanels.jpg" media="(min-width:768px)">
                            <source srcset="assets/handheldcontrollerPanels.jpg" media="(min-width:540px)">
                            <source srcset="assets/handheldcontrollerPanels.jpg" media="(min-width:0)">
                            <img srcset="assets/handheldcontrollerPanels.jpg" src="assets/handheldcontrollerPanels.jpg" alt="Placeholder with grey background and dimension watermark without any imagery">
                        </picture>
                    </li>
