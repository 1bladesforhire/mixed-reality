    ...
    <ul role="tablist">
        <li class="c-glyph" role="presentation">
            <a href="#" role="tab" class="c-logo f-active" itemprop="url" aria-label="Item 1" aria-controls="newIconItemImage1 newIconItemContent1">
                <img itemprop="logo" class="c-image" src="assets/thumb-3.jpg" alt="Phone icon" itemscope itemtype="http://schema.org/ImageObject">
                <span>Game 1</span>
            </a>
        </li>
        <li class="c-glyph" role="presentation">
            <a href="#" role="tab" class="c-logo" itemprop="url" aria-label="Item 2" aria-controls="newIconItemImage2 newIconItemContent2">
                <img itemprop="logo" class="c-image" src="assets/thumb-4.jpg" alt="Calendar icon" itemscope itemtype="http://schema.org/ImageObject">
                <span>Game 2</span>
            </a>
        </li>
        <li class="c-glyph" role="presentation">
            <a href="#" role="tab" class="c-logo" itemprop="url" aria-label="Item 3" aria-controls="newIconItemImage3 newIconItemContent3">
                <img itemprop="logo" class="c-image" src="assets/thumb-5.jpg" alt="Mail icon" itemscope itemtype="http://schema.org/ImageObject">
                <span>Game 3</span>
            </a>
        </li>
        <li class="c-glyph" role="presentation">
            <a href="#" role="tab" class="c-logo" itemprop="url" aria-label="Item 4" aria-controls="newIconItemImage4 newIconItemContent4">
                <img itemprop="logo" class="c-image" src="assets/thumb-2.jpg" alt="Image icon" itemscope itemtype="http://schema.org/ImageObject">
                <span>Game 4</span>
            </a>
        </li>
    </ul>
