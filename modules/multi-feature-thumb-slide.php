<section data-grid="container stack-2" class="m-multi-feature f-align-center" id="m-multi-tiles">
    ...
    <section data-grid="container">
        ...
        <li class="c-glyph" role="presentation" class="li-active">
                <a href="#" role="tab" class="c-logo f-active" itemprop="url" aria-label="Item 15" aria-controls="newIconItemImage15 newIconItemContent15">
                    <img itemprop="logo" class="c-image f-active" src="assets/video/nav5.jpg" alt="Image icon" itemscope itemtype="http://schema.org/ImageObject">
                    <span>Minecraft</span>
                </a>
            </li>
        ...
        <ul id="m-multi-description">
            <li id="newIconItemContent15" role="tabpanel" class="f-active">
        ...
        <div class="c-carousel f-multi-slide" role="region" aria-label="Images">
            ...
            <div itemscope itemtype="http://schema.org/ItemList">
                <ul>
                    <li id="newIconItemImage15" dat1a-f-theme="dark" role="tabpanel" class="f-active">
                    ...
                    <div id="video5" class="lightbox" onclick="hideVideo('video5','youtube5')">
                        <div class="lightbox-container">  
                            <div class="lightbox-content">
                                ...
                                <div class="video-container  youtube-player" data-id="nGUab4jwbwg" youtube="youtube5">
