        ...
        <div itemscope itemtype="http://schema.org/ItemList">
            <ul>
                ...
                <li id="default-align-top" data-f-theme="light" >
                    <section class="m-immersive-hero-item theme-light f-align-top">
                        <picture class="c-image">
                            <source srcset="assets/video/acer-hero-macro-2.jpg" media="(min-width: 1779px)">
                            <source srcset="assets/video/acer-hero-macro-2.jpg" media="(min-width:1400px)">
                            <source srcset="assets/video/acer-hero-macro-2.jpg" media="(min-width:1084px)">
                            <source srcset="assets/video/acer-hero-macro-2.jpg" media="(min-width:768px)">
                            <source srcset="assets/video/acer-hero-macro-2.jpg" media="(min-width:540px)">
                            <source srcset="assets/video/acer-hero-macro-2.jpg" media="(min-width:0)">
                            <img srcset="assets/video/acer-hero-macro-2.jpg" src="assets/video/acer-hero-macro-2.jpg" alt="Placeholder with grey background and dimension watermark without any imagery">
                        </picture>
                ...
                <li id="default-align-top" data-f-theme="light" >
                    <section class="m-immersive-hero-item theme-light f-align-top">
                        <picture class="c-image">
                            <source srcset="assets/video/acer-hero-macro-3.jpg" media="(min-width: 1779px)">
                            <source srcset="assets/video/acer-hero-macro-3.jpg" media="(min-width:1400px)">
                            <source srcset="assets/video/acer-hero-macro-3.jpg" media="(min-width:1084px)">
                            <source srcset="assets/video/acer-hero-macro-3.jpg" media="(min-width:768px)">
                            <source srcset="assets/video/acer-hero-macro-3.jpg" media="(min-width:540px)">
                            <source srcset="assets/video/acer-hero-macro-3.jpg" media="(min-width:0)">
                            <img srcset="assets/video/acer-hero-macro-3.jpg" src="assets/video/acer-hero-macro-3.jpg" alt="Placeholder with grey background and dimension watermark without any imagery">
                        </picture>
            ...
            <div data-grid="col-6">
                <div class="inner">
                    ...
                    <ul class="bullets">
                        ...
                        <li>Is your Windows 10 PC ready for Windows Mixed Reality? <a href="https://www.microsoft.com/en-us/store/p/windows-mixed-reality-pc-check/9nzvl19n7cnc?rtc=1" target="_blank" rel="no-follow" class="f-blue">Check compatibility</a></li>
                    </ul>
                </div>
            </div>
            <div data-grid="col-3">
